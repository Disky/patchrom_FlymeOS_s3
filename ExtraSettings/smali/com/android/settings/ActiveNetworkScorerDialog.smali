.class public final Lcom/android/extrasettings/ActiveNetworkScorerDialog;
...
.method private buildDialog()Z
    ...
    .line 77
    :cond_0
    iget-object v6, p0, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->mNewPackageName:Ljava/lang/String;
    ...
    iget-object v7, p0, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->mNewPackageName:Ljava/lang/String;
    ...
    invoke-virtual {p0, v5}, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->setResult(I)V
    ...
    iget-object v3, p0, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->mAlertParams:Lcom/android/internal/app/AlertController$AlertParams;

    .line 94
    .local v3, "p":Lcom/android/internal/app/AlertController$AlertParams;
    const v6, 0x7f0907f4

    invoke-virtual {p0, v6}, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v6, v7}, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->getString(I)Ljava/lang/String;
    ...
    .line 106
    invoke-virtual {p0}, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->setupAlert()V
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->mNewPackageName:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->setResult(I)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 49
    invoke-virtual {p0}, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->getIntent()Landroid/content/Intent;
    ...
    iput-object v1, p0, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->mNewPackageName:Ljava/lang/String;

    .line 52
    invoke-direct {p0}, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->buildDialog()Z
    ...
    .line 53
    invoke-virtual {p0}, Lcom/android/extrasettings/ActiveNetworkScorerDialog;->finish()V
