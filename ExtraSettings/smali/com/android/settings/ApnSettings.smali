...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/extrasettings/ApnSettings$ApnInfo;,
        ...
        Lcom/android/extrasettings/ApnSettings$ApnObserver;
    }
.end annotation
...
# instance fields
.field private mApnObserver:Lcom/android/extrasettings/ApnSettings$ApnObserver;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/extrasettings/ApnSettings;->mUseNvOperatorForEhrpd:Z
    ...
    iput-object v0, p0, Lcom/android/extrasettings/ApnSettings;->mHandler:Landroid/os/Handler;
...
.method static synthetic access$100(Lcom/android/extrasettings/ApnSettings;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/extrasettings/ApnSettings;

    .prologue
    .line 64
    invoke-direct {p0}, Lcom/android/extrasettings/ApnSettings;->handleResetOrFill()V
...
.method static synthetic access$200()Landroid/net/Uri;
    ...
    .prologue
    .line 64
    sget-object v0, Lcom/android/extrasettings/ApnSettings;->PREFERAPN_URI:Landroid/net/Uri;
...
.method static synthetic access$500(Lcom/android/extrasettings/ApnSettings;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/extrasettings/ApnSettings;
...
.method private addNewApn()V
    ...
    invoke-direct {p0, v2}, Lcom/android/extrasettings/ApnSettings;->getUri(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    invoke-direct {p0}, Lcom/android/extrasettings/ApnSettings;->getOperatorNumeric()[Ljava/lang/String;
...
.method private createApnPreference(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Lcom/android/extrasettings/ApnPreference;
    .locals 3
    ...
    .line 358
    new-instance v0, Lcom/android/extrasettings/ApnPreference;
    ...
    .line 360
    .local v0, "pref":Lcom/android/extrasettings/ApnPreference;
    invoke-virtual {v0, p5}, Lcom/android/extrasettings/ApnPreference;->setApnReadOnly(Z)V

    .line 361
    invoke-virtual {v0, p2}, Lcom/android/extrasettings/ApnPreference;->setKey(Ljava/lang/String;)V

    .line 362
    invoke-virtual {v0, p1}, Lcom/android/extrasettings/ApnPreference;->setTitle(Ljava/lang/CharSequence;)V

    .line 363
    invoke-virtual {v0, p3}, Lcom/android/extrasettings/ApnPreference;->setSummary(Ljava/lang/CharSequence;)V

    .line 364
    invoke-virtual {v0, v1}, Lcom/android/extrasettings/ApnPreference;->setPersistent(Z)V

    .line 365
    invoke-virtual {v0, p0}, Lcom/android/extrasettings/ApnPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V
...
.method private fillList()V
    ...
    .prologue
    .line 265
    invoke-direct/range {p0 .. p0}, Lcom/android/extrasettings/ApnSettings;->getOperatorNumericSelection()Ljava/lang/String;
    ...
    invoke-direct {v0, v6}, Lcom/android/extrasettings/ApnSettings;->getUri(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    iget v5, v0, Lcom/android/extrasettings/ApnSettings;->mSubId:I
    ...
    invoke-virtual {v0, v5}, Lcom/android/extrasettings/ApnSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    iput-object v5, v0, Lcom/android/extrasettings/ApnSettings;->mSelectedKey:Ljava/lang/String;
    ...
    .line 302
    invoke-direct/range {v9 .. v14}, Lcom/android/extrasettings/ApnSettings;->createApnPreference(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Lcom/android/extrasettings/ApnPreference;

    move-result-object v34

    .line 304
    .local v34, "pref":Lcom/android/extrasettings/ApnPreference;
    invoke-virtual/range {v34 .. v34}, Lcom/android/extrasettings/ApnPreference;->getSelectable()Z
    ...
    iget-object v5, v0, Lcom/android/extrasettings/ApnSettings;->mSelectedKey:Ljava/lang/String;
    ...
    .line 306
    invoke-virtual/range {v34 .. v34}, Lcom/android/extrasettings/ApnPreference;->setChecked()V
    ...
    iget-object v9, v0, Lcom/android/extrasettings/ApnSettings;->mSelectedKey:Ljava/lang/String;
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lcom/android/extrasettings/ApnSettings;->mvnoMatches(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .end local v34    # "pref":Lcom/android/extrasettings/ApnPreference;
    :cond_2
    const/4 v14, 0x0
    ...
    .restart local v34    # "pref":Lcom/android/extrasettings/ApnPreference;
    :cond_4
    ...
    .line 322
    :cond_6
    new-instance v15, Lcom/android/extrasettings/ApnSettings$ApnInfo;
    ...
    invoke-direct/range {v15 .. v22}, Lcom/android/extrasettings/ApnSettings$ApnInfo;-><init>(Lcom/android/extrasettings/ApnSettings;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V

    .line 323
    .local v15, "apnInfo":Lcom/android/extrasettings/ApnSettings$ApnInfo;
    const-string v5, "spn"
    ...
    .end local v14    # "readOnly":Z
    .end local v15    # "apnInfo":Lcom/android/extrasettings/ApnSettings$ApnInfo;
    .end local v21    # "mvnoType":Ljava/lang/String;
    .end local v28    # "isMvno":Z
    .end local v30    # "mvnoData":Ljava/lang/String;
    .end local v34    # "pref":Lcom/android/extrasettings/ApnPreference;
...
.method private getOperatorNumeric()[Ljava/lang/String;
    ...
    iget-boolean v3, p0, Lcom/android/extrasettings/ApnSettings;->mUseNvOperatorForEhrpd:Z
    ...
    iget v4, p0, Lcom/android/extrasettings/ApnSettings;->mSubId:I
    ...
    iget v5, p0, Lcom/android/extrasettings/ApnSettings;->mSubId:I
...
.method private getSelectedApnKey()Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/extrasettings/ApnSettings;->PREFERAPN_URI:Landroid/net/Uri;

    invoke-direct {p0, v1}, Lcom/android/extrasettings/ApnSettings;->getUri(Landroid/net/Uri;)Landroid/net/Uri;
...
.method private getUri(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    iget v1, p0, Lcom/android/extrasettings/ApnSettings;->mSubId:I
...
.method private handleResetOrFill()V
    ...
    .line 235
    :cond_1
    iget-object v0, p0, Lcom/android/extrasettings/ApnSettings;->mDialog:Landroid/app/ProgressDialog;
...
.method private static mvnoMatches(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p1, p3}, Lcom/android/extrasettings/ApnSettings;->imsiMatches(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private setSelectedApnKey(Ljava/lang/String;)V
    ...
    .line 475
    sget-object v2, Lcom/android/extrasettings/ApnSettings;->PREFERAPN_URI:Landroid/net/Uri;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iput v1, p0, Lcom/android/extrasettings/ApnSettings;->mSubId:I
    ...
    iget v3, p0, Lcom/android/extrasettings/ApnSettings;->mSubId:I
    ...
    iput-object v1, p0, Lcom/android/extrasettings/ApnSettings;->mMobileStateFilter:Landroid/content/IntentFilter;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/extrasettings/ApnSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/os/UserManager;

    iput-object v0, p0, Lcom/android/extrasettings/ApnSettings;->mUm:Landroid/os/UserManager;
    ...
    iput-object v0, p0, Lcom/android/extrasettings/ApnSettings;->mMobileStateFilter:Landroid/content/IntentFilter;

    .line 177
    new-instance v0, Lcom/android/extrasettings/ApnSettings$ApnObserver;

    iget-object v1, p0, Lcom/android/extrasettings/ApnSettings;->mHandler:Landroid/os/Handler;

    invoke-direct {v0, p0, v1}, Lcom/android/extrasettings/ApnSettings$ApnObserver;-><init>(Lcom/android/extrasettings/ApnSettings;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/extrasettings/ApnSettings;->mApnObserver:Lcom/android/extrasettings/ApnSettings$ApnObserver;

    .line 179
    iget-object v0, p0, Lcom/android/extrasettings/ApnSettings;->mUm:Landroid/os/UserManager;
    ...
    invoke-virtual {p0, v0}, Lcom/android/extrasettings/ApnSettings;->setHasOptionsMenu(Z)V
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    iput-object v0, p0, Lcom/android/extrasettings/ApnSettings;->mDialog:Landroid/app/ProgressDialog;
...
.method public onPause()V
    ...
    .line 248
    :cond_0
    iget-object v0, p0, Lcom/android/extrasettings/ApnSettings;->mApnObserver:Lcom/android/extrasettings/ApnSettings$ApnObserver;
    ...
    invoke-virtual {v0}, Lcom/android/extrasettings/ApnSettings$ApnObserver;->endObserving()V
    ...
    iget-object v1, p0, Lcom/android/extrasettings/ApnSettings;->mMobileStateReceiver:Landroid/content/BroadcastReceiver;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/extrasettings/ApnSettings;->startActivity(Landroid/content/Intent;)V
...
.method public onResume()V
    ...
    invoke-virtual {v0}, Lcom/android/extrasettings/ApnSettings$ApnObserver;->startObserving()V
