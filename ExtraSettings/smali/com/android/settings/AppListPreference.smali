.class public Lcom/android/extrasettings/AppListPreference;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/extrasettings/AppListPreference$AppArrayAdapter;
    }
.end annotation
...
.method protected onPrepareDialogBuilder(Landroid/app/AlertDialog$Builder;)V
    ...
    .prologue
    .line 120
    invoke-virtual {p0}, Lcom/android/extrasettings/AppListPreference;->getValue()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v1}, Lcom/android/extrasettings/AppListPreference;->findIndexOfValue(Ljava/lang/String;)I

    move-result v6

    .line 121
    .local v6, "selectedIndex":I
    new-instance v0, Lcom/android/extrasettings/AppListPreference$AppArrayAdapter;

    invoke-virtual {p0}, Lcom/android/extrasettings/AppListPreference;->getContext()Landroid/content/Context;

    move-result-object v2

    const v3, 0x7f04000e

    invoke-virtual {p0}, Lcom/android/extrasettings/AppListPreference;->getEntries()[Ljava/lang/CharSequence;

    move-result-object v4

    iget-object v5, p0, Lcom/android/extrasettings/AppListPreference;->mEntryDrawables:[Landroid/graphics/drawable/Drawable;

    move-object v1, p0

    invoke-direct/range {v0 .. v6}, Lcom/android/extrasettings/AppListPreference$AppArrayAdapter;-><init>(Lcom/android/extrasettings/AppListPreference;Landroid/content/Context;I[Ljava/lang/CharSequence;[Landroid/graphics/drawable/Drawable;I)V
...
.method public setPackageNames([Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v11, p0, Lcom/android/extrasettings/AppListPreference;->mEntryDrawables:[Landroid/graphics/drawable/Drawable;
    ...
    .line 101
    iget-object v11, p0, Lcom/android/extrasettings/AppListPreference;->mEntryDrawables:[Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-virtual {p0, v2}, Lcom/android/extrasettings/AppListPreference;->setEntries([Ljava/lang/CharSequence;)V

    .line 110
    invoke-virtual {p0, p1}, Lcom/android/extrasettings/AppListPreference;->setEntryValues([Ljava/lang/CharSequence;)V
    ...
    .line 112
    invoke-virtual {p0, v10}, Lcom/android/extrasettings/AppListPreference;->setValueIndex(I)V
    ...
    invoke-virtual {p0, v11}, Lcom/android/extrasettings/AppListPreference;->setValue(Ljava/lang/String;)V
