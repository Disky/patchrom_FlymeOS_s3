.class public Lcom/android/extrasettings/DataUsageSummary$WarningEditorFragment;
...
.method public static show(Lcom/android/extrasettings/DataUsageSummary;)V
    ...
    .line 1998
    new-instance v1, Lcom/android/extrasettings/DataUsageSummary$WarningEditorFragment;

    invoke-direct {v1}, Lcom/android/extrasettings/DataUsageSummary$WarningEditorFragment;-><init>()V

    .line 1999
    .local v1, "dialog":Lcom/android/extrasettings/DataUsageSummary$WarningEditorFragment;
    invoke-virtual {v1, v0}, Lcom/android/extrasettings/DataUsageSummary$WarningEditorFragment;->setArguments(Landroid/os/Bundle;)V

    .line 2000
    const/4 v2, 0x0

    invoke-virtual {v1, p0, v2}, Lcom/android/extrasettings/DataUsageSummary$WarningEditorFragment;->setTargetFragment(Landroid/app/Fragment;I)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/extrasettings/DataUsageSummary$WarningEditorFragment;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .prologue
    .line 2006
    invoke-virtual {p0}, Lcom/android/extrasettings/DataUsageSummary$WarningEditorFragment;->getActivity()Landroid/app/Activity;

    move-result-object v7

    .line 2007
    .local v7, "context":Landroid/content/Context;
    invoke-virtual {p0}, Lcom/android/extrasettings/DataUsageSummary$WarningEditorFragment;->getTargetFragment()Landroid/app/Fragment;
    ...
    invoke-virtual {p0}, Lcom/android/extrasettings/DataUsageSummary$WarningEditorFragment;->getArguments()Landroid/os/Bundle;
    ...
    .line 2032
    const v14, 0x7f090bd0

    new-instance v0, Lcom/android/extrasettings/DataUsageSummary$WarningEditorFragment$1;

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lcom/android/extrasettings/DataUsageSummary$WarningEditorFragment$1;-><init>(Lcom/android/extrasettings/DataUsageSummary$WarningEditorFragment;Landroid/widget/NumberPicker;Lcom/android/extrasettings/net/NetworkPolicyEditor;Landroid/net/NetworkTemplate;Lcom/android/extrasettings/DataUsageSummary;)V
