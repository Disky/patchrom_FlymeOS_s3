.class public Lcom/android/extrasettings/DeviceAdminSettings;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/extrasettings/DeviceAdminSettings$PolicyListAdapter;,
        Lcom/android/extrasettings/DeviceAdminSettings$ViewHolder;
    }
.end annotation
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mAdminsByProfile:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mProfileOwnerComponents:Landroid/util/SparseArray;

    .line 73
    new-instance v0, Lcom/android/extrasettings/DeviceAdminSettings$1;

    invoke-direct {v0, p0}, Lcom/android/extrasettings/DeviceAdminSettings$1;-><init>(Lcom/android/extrasettings/DeviceAdminSettings;)V

    iput-object v0, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;

    .line 180
    return-void
.end method

.method static synthetic access$000(Lcom/android/extrasettings/DeviceAdminSettings;)Landroid/util/SparseArray;
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/DeviceAdminSettings;

    .prologue
    .line 57
    iget-object v0, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mAdminsByProfile:Landroid/util/SparseArray;

    return-object v0
.end method

.method static synthetic access$100(Lcom/android/extrasettings/DeviceAdminSettings;Landroid/app/admin/DeviceAdminInfo;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/DeviceAdminSettings;
    ...
    .prologue
    .line 57
    invoke-direct {p0, p1}, Lcom/android/extrasettings/DeviceAdminSettings;->isActiveAdmin(Landroid/app/admin/DeviceAdminInfo;)Z
...
.method static synthetic access$200(Lcom/android/extrasettings/DeviceAdminSettings;Landroid/app/admin/DeviceAdminInfo;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/DeviceAdminSettings;
    .param p1, "x1"    # Landroid/app/admin/DeviceAdminInfo;
    ...
    .prologue
    .line 57
    invoke-direct {p0, p1}, Lcom/android/extrasettings/DeviceAdminSettings;->getUserId(Landroid/app/admin/DeviceAdminInfo;)I
...
.method static synthetic access$300(Lcom/android/extrasettings/DeviceAdminSettings;Landroid/app/admin/DeviceAdminInfo;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/DeviceAdminSettings;
    .param p1, "x1"    # Landroid/app/admin/DeviceAdminInfo;
    ...
    .prologue
    .line 57
    invoke-direct {p0, p1}, Lcom/android/extrasettings/DeviceAdminSettings;->isDeviceOwner(Landroid/app/admin/DeviceAdminInfo;)Z
...
.method static synthetic access$400(Lcom/android/extrasettings/DeviceAdminSettings;Landroid/app/admin/DeviceAdminInfo;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/DeviceAdminSettings;
    .param p1, "x1"    # Landroid/app/admin/DeviceAdminInfo;
    ...
    .prologue
    .line 57
    invoke-direct {p0, p1}, Lcom/android/extrasettings/DeviceAdminSettings;->isProfileOwner(Landroid/app/admin/DeviceAdminInfo;)Z
...
.method static synthetic access$500(Lcom/android/extrasettings/DeviceAdminSettings;Landroid/app/admin/DeviceAdminInfo;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/DeviceAdminSettings;
    .param p1, "x1"    # Landroid/app/admin/DeviceAdminInfo;
    ...
    .prologue
    .line 57
    invoke-direct {p0, p1}, Lcom/android/extrasettings/DeviceAdminSettings;->isRemovingAdmin(Landroid/app/admin/DeviceAdminInfo;)Z
...
.method private addActiveAdminsForProfile(Ljava/util/List;I)V
    ...
    .line 445
    invoke-virtual {p0}, Lcom/android/extrasettings/DeviceAdminSettings;->getActivity()Landroid/app/Activity;
    ...
    invoke-direct {p0, v9}, Lcom/android/extrasettings/DeviceAdminSettings;->createDeviceAdminInfo(Landroid/content/pm/ResolveInfo;)Landroid/app/admin/DeviceAdminInfo;
    ...
    .line 464
    iget-object v9, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mAdminsByProfile:Landroid/util/SparseArray;
...
.method private addDeviceAdminBroadcastReceiversForProfile(Ljava/util/Collection;I)V
    ...
    .line 413
    .local v4, "n":I
    iget-object v8, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mAdminsByProfile:Landroid/util/SparseArray;
    ...
    .line 424
    :cond_2
    invoke-direct {p0, v6}, Lcom/android/extrasettings/DeviceAdminSettings;->createDeviceAdminInfo(Landroid/content/pm/ResolveInfo;)Landroid/app/admin/DeviceAdminInfo;
...
.method private isActiveAdmin(Landroid/app/admin/DeviceAdminInfo;)Z
    ...
    .prologue
    .line 367
    iget-object v0, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mDPM:Landroid/app/admin/DevicePolicyManager;
...
.method private isDeviceOwner(Landroid/app/admin/DeviceAdminInfo;)Z
    ...
    iget-object v1, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mDeviceOwnerPkg:Ljava/lang/String;
...
.method private isProfileOwner(Landroid/app/admin/DeviceAdminInfo;)Z
    ...
    .prologue
    .line 362
    iget-object v1, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mProfileOwnerComponents:Landroid/util/SparseArray;
...
.method private updateAvailableAdminsForProfile(I)V
    ...
    .prologue
    .line 385
    iget-object v1, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/extrasettings/DeviceAdminSettings;->addActiveAdminsForProfile(Ljava/util/List;I)V

    .line 389
    invoke-direct {p0, v0, p1}, Lcom/android/extrasettings/DeviceAdminSettings;->addDeviceAdminBroadcastReceiversForProfile(Ljava/util/Collection;I)V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 102
    invoke-virtual {p0}, Lcom/android/extrasettings/DeviceAdminSettings;->getListView()Landroid/widget/ListView;

    move-result-object v0

    const/4 v1, 0x1

    invoke-static {v0, v1}, Lcom/android/extrasettings/Utils;->forceCustomPadding(Landroid/view/View;Z)V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    iput-object v0, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mUm:Landroid/os/UserManager;
...
.method public onListItemClick(Landroid/widget/ListView;Landroid/view/View;IJ)V
    ...
    invoke-direct {p0, v2}, Lcom/android/extrasettings/DeviceAdminSettings;->getUserId(Landroid/app/admin/DeviceAdminInfo;)I
    ...
    invoke-direct {p0, v2}, Lcom/android/extrasettings/DeviceAdminSettings;->isProfileOwner(Landroid/app/admin/DeviceAdminInfo;)Z
    ...
    const-class v6, Lcom/android/extrasettings/DeviceAdminAdd;
    ...
    invoke-virtual {p0, v6, v7}, Lcom/android/extrasettings/DeviceAdminSettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method public onPause()V
    ...
    iget-object v1, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method public onResume()V
    ...
    iput-object v0, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mDeviceOwnerPkg:Ljava/lang/String;

    .line 113
    iget-object v0, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mDeviceOwnerPkg:Ljava/lang/String;
    ...
    .line 114
    iput-object v4, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mDeviceOwnerPkg:Ljava/lang/String;

    .line 116
    :cond_0
    iget-object v0, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mProfileOwnerComponents:Landroid/util/SparseArray;

    invoke-virtual {v0}, Landroid/util/SparseArray;->clear()V

    .line 117
    iget-object v0, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mUm:Landroid/os/UserManager;
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/android/extrasettings/DeviceAdminSettings;->updateList()V
...
.method updateList()V
    ...
    .prologue
    .line 137
    iget-object v4, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mAdminsByProfile:Landroid/util/SparseArray;

    invoke-virtual {v4}, Landroid/util/SparseArray;->clear()V

    .line 139
    iget-object v4, p0, Lcom/android/extrasettings/DeviceAdminSettings;->mUm:Landroid/os/UserManager;
    ...
    invoke-direct {p0, v1}, Lcom/android/extrasettings/DeviceAdminSettings;->updateAvailableAdminsForProfile(I)V
    ...
    new-instance v5, Lcom/android/extrasettings/DeviceAdminSettings$PolicyListAdapter;

    invoke-direct {v5, p0}, Lcom/android/extrasettings/DeviceAdminSettings$PolicyListAdapter;-><init>(Lcom/android/extrasettings/DeviceAdminSettings;)V
