...
.method public constructor <init>(Landroid/content/Context;Lcom/android/extrasettings/bluetooth/CachedBluetoothDevice;)V
    ...
    .line 346
    new-instance v2, Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference$2;

    invoke-direct {v2, p0}, Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference$2;-><init>(Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;)V

    iput-object v2, p0, Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;->mBluetoothReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$100(Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;)Landroid/content/BroadcastReceiver;
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;

    .prologue
    .line 51
    iget-object v0, p0, Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;->mBluetoothReceiver:Landroid/content/BroadcastReceiver;

    return-object v0
.end method

.method static synthetic access$200(Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;

    .prologue
    .line 51
    iget-object v0, p0, Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;->mContext:Landroid/content/Context;

    return-object v0
.end method

.method static synthetic access$300(Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;)Landroid/app/AlertDialog;
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;
...
.method private askDisconnect()V
    ...
    iput-object v5, p0, Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;->mContext:Landroid/content/Context;
    ...
    .line 205
    iget-object v5, p0, Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;->mContext:Landroid/content/Context;
    ...
    iget-object v6, p0, Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;->mBluetoothReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {v5, v6, v1}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    .line 213
    new-instance v0, Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference$1;

    invoke-direct {v0, p0}, Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference$1;-><init>(Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;)V

    .line 227
    .local v0, "disconnectListener":Landroid/content/DialogInterface$OnClickListener;
    iget-object v5, p0, Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;->mContext:Landroid/content/Context;

    iget-object v6, p0, Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;->mDisconnectDialog:Landroid/app/AlertDialog;

    invoke-static {v2}, Landroid/text/Html;->fromHtml(Ljava/lang/String;)Landroid/text/Spanned;

    move-result-object v7

    invoke-static {v5, v6, v0, v4, v7}, Lcom/android/extrasettings/bluetooth/Utils;->showDisconnectDialog(Landroid/content/Context;Landroid/app/AlertDialog;Landroid/content/DialogInterface$OnClickListener;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Landroid/app/AlertDialog;
...
.method private getConnectionSummary()I
    ...
    instance-of v7, v5, Lcom/android/extrasettings/bluetooth/A2dpSinkProfile;
