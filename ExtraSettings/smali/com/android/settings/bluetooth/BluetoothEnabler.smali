...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/Switch;)V
    ...
    .line 49
    new-instance v0, Lcom/android/extrasettings/bluetooth/BluetoothEnabler$1;

    invoke-direct {v0, p0}, Lcom/android/extrasettings/bluetooth/BluetoothEnabler$1;-><init>(Lcom/android/extrasettings/bluetooth/BluetoothEnabler;)V

    iput-object v0, p0, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->mHandler:Landroid/os/Handler;

    .line 62
    new-instance v0, Lcom/android/extrasettings/bluetooth/BluetoothEnabler$2;

    invoke-direct {v0, p0}, Lcom/android/extrasettings/bluetooth/BluetoothEnabler$2;-><init>(Lcom/android/extrasettings/bluetooth/BluetoothEnabler;)V

    iput-object v0, p0, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->mReceiver:Landroid/content/BroadcastReceiver;

    .line 81
    invoke-direct {p0}, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->init()V
...
.method private init()V
    ...
    .prologue
    .line 85
    iget-object v1, p0, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v1}, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->setEnabled(Z)V
...
.method handleStateChanged(I)V
    ...
    .line 147
    invoke-virtual {p0, v0}, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->setChecked(Z)V

    .line 148
    invoke-virtual {p0, v1}, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->setEnabled(Z)V

    .line 149
    invoke-direct {p0, v0}, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->updateSearchIndex(Z)V
    ...
    .line 131
    :pswitch_0
    invoke-virtual {p0, v0}, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->setEnabled(Z)V

    goto :goto_0

    .line 134
    :pswitch_1
    invoke-virtual {p0, v1}, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->setChecked(Z)V

    .line 135
    invoke-virtual {p0, v1}, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->setEnabled(Z)V

    .line 136
    invoke-direct {p0, v1}, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->updateSearchIndex(Z)V
...
.method public onSwitchChanged(Landroid/widget/Switch;Z)V
    ...
    .line 164
    iget-boolean v0, p0, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->mStateMachineEvent:Z
    ...
    .line 172
    invoke-virtual {p0, v2}, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->setChecked(Z)V
    ...
    .line 178
    :cond_2
    invoke-virtual {p0, v2}, Lcom/android/extrasettings/bluetooth/BluetoothEnabler;->setEnabled(Z)V
