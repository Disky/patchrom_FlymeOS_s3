.class public final Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;
...
.method public constructor <init>()V
    ...
    .line 49
    iput-object v0, p0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;

    .line 50
    iput-object v0, p0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
...
.method private checkUserChoice()Z
    ...
    iget v8, p0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
    ...
    :cond_0
    iget-object v8, p0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mContext:Landroid/content/Context;

    invoke-static {v8}, Lcom/android/extrasettings/bluetooth/LocalBluetoothManager;->getInstance(Landroid/content/Context;)Lcom/android/extrasettings/bluetooth/LocalBluetoothManager;

    move-result-object v0

    .line 204
    .local v0, "bluetoothManager":Lcom/android/extrasettings/bluetooth/LocalBluetoothManager;
    ...
    .line 206
    .local v2, "cachedDeviceManager":Lcom/android/extrasettings/bluetooth/CachedBluetoothDeviceManager;
    iget-object v8, p0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;

    invoke-virtual {v2, v8}, Lcom/android/extrasettings/bluetooth/CachedBluetoothDeviceManager;->findDevice(Landroid/bluetooth/BluetoothDevice;)Lcom/android/extrasettings/bluetooth/CachedBluetoothDevice;
    ...
    iget-object v10, p0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;

    invoke-virtual {v2, v8, v9, v10}, Lcom/android/extrasettings/bluetooth/CachedBluetoothDeviceManager;->addDevice(Lcom/android/extrasettings/bluetooth/LocalBluetoothAdapter;Lcom/android/extrasettings/bluetooth/LocalBluetoothProfileManager;Landroid/bluetooth/BluetoothDevice;)Lcom/android/extrasettings/bluetooth/CachedBluetoothDevice;
    ...
    .line 220
    invoke-direct {p0, v11}, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->sendReplyIntentToReceiver(Z)V
    ...
    .line 223
    invoke-direct {p0, v13}, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->sendReplyIntentToReceiver(Z)V
...
.method private getNotificationTag(I)Ljava/lang/String;
    ...
    .line 182
    :cond_0
    iget v0, p0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
...
.method private sendReplyIntentToReceiver(Z)V
    ...
    iget-object v1, p0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    iget v2, p0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mRequestType:I

    invoke-virtual {v0, v1, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    .line 259
    iget-object v1, p0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mContext:Landroid/content/Context;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iput-object v0, v1, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mContext:Landroid/content/Context;
    ...
    invoke-static {v13}, Lcom/android/extrasettings/Utils;->isManagedProfile(Landroid/os/UserManager;)Z
    ...
    iput-object v14, v0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    iput v14, v0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
    ...
    iput-object v14, v0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;
    ...
    iput-object v14, v0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;

    .line 87
    invoke-direct/range {p0 .. p0}, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->checkUserChoice()Z
    ...
    const-class v14, Lcom/android/extrasettings/bluetooth/BluetoothPermissionActivity;
    ...
    iget v14, v0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
    ...
    iget v15, v0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
    ...
    iget-object v15, v0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    iget-object v15, v0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;
    ...
    iget-object v15, v0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
    ...
    iget-object v14, v0, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-static {v0, v5}, Lcom/android/extrasettings/bluetooth/LocalBluetoothPreferences;->shouldShowDialogInForeground(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v14}, Lcom/android/extrasettings/bluetooth/BluetoothPermissionRequest;->getNotificationTag(I)Ljava/lang/String;
