...
.method public onPause()V
    ...
    .line 114
    :cond_1
    invoke-virtual {p0}, Lcom/android/extrasettings/bluetooth/DeviceListPreferenceFragment;->removeAllDevices()V
...
.method public onScanningStateChanged(Z)V
    ...
    .line 218
    invoke-virtual {p0}, Lcom/android/extrasettings/bluetooth/DeviceListPreferenceFragment;->removeOorDevices()V
...
.method removeOorDevices()V
    ...
    .prologue
    .line 134
    iget-object v4, p0, Lcom/android/extrasettings/bluetooth/DeviceListPreferenceFragment;->mLocalManager:Lcom/android/extrasettings/bluetooth/LocalBluetoothManager;

    invoke-virtual {v4}, Lcom/android/extrasettings/bluetooth/LocalBluetoothManager;->getCachedDeviceManager()Lcom/android/extrasettings/bluetooth/CachedBluetoothDeviceManager;

    move-result-object v4

    invoke-virtual {v4}, Lcom/android/extrasettings/bluetooth/CachedBluetoothDeviceManager;->getCachedDevicesCopy()Ljava/util/Collection;
    ...
    invoke-virtual {v0}, Lcom/android/extrasettings/bluetooth/CachedBluetoothDevice;->isVisible()Z
    ...
    .line 140
    iget-object v4, p0, Lcom/android/extrasettings/bluetooth/DeviceListPreferenceFragment;->mDevicePreferenceMap:Ljava/util/WeakHashMap;

    invoke-virtual {v4, v0}, Ljava/util/WeakHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;

    .line 141
    .local v3, "preference":Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;
    if-eqz v3, :cond_1

    .line 142
    iget-object v4, p0, Lcom/android/extrasettings/bluetooth/DeviceListPreferenceFragment;->mDeviceListGroup:Landroid/preference/PreferenceGroup;
    ...
    invoke-virtual {v0, v4}, Lcom/android/extrasettings/bluetooth/CachedBluetoothDevice;->setRemovable(Z)V

    goto :goto_0

    .line 148
    .end local v0    # "cachedDevice":Lcom/android/extrasettings/bluetooth/CachedBluetoothDevice;
    .end local v3    # "preference":Lcom/android/extrasettings/bluetooth/BluetoothDevicePreference;
    :cond_2
    return-void
.end method
