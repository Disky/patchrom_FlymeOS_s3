...
.method static synthetic access$000(Lcom/android/extrasettings/bluetooth/DeviceProfilesSettings;)V
    .locals 0
...
.method static synthetic access$100(Lcom/android/extrasettings/bluetooth/DeviceProfilesSettings;Landroid/preference/CheckBoxPreference;Lcom/android/extrasettings/bluetooth/LocalBluetoothProfile;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/extrasettings/bluetooth/DeviceProfilesSettings;
...
.method private addPreferencesForProfiles()V
    ...
    instance-of v9, v7, Lcom/android/extrasettings/bluetooth/PbapServerProfile;

    if-nez v9, :cond_0

    instance-of v9, v7, Lcom/android/extrasettings/bluetooth/MapProfile;
    ...
    .end local v3    # "mapProfile":Lcom/android/extrasettings/bluetooth/MapProfile;
    :cond_3
...
.method private onProfileClicked(Lcom/android/extrasettings/bluetooth/LocalBluetoothProfile;Landroid/preference/CheckBoxPreference;)V
    ...
    invoke-virtual {v5}, Lcom/android/extrasettings/bluetooth/CachedBluetoothDevice;->getDevice()Landroid/bluetooth/BluetoothDevice;
    ...
    .line 241
    iget-object v3, p0, Lcom/android/extrasettings/bluetooth/DeviceProfilesSettings;->mManager:Lcom/android/extrasettings/bluetooth/LocalBluetoothManager;
    ...
    invoke-direct {p0, v3, p1}, Lcom/android/extrasettings/bluetooth/DeviceProfilesSettings;->askDisconnect(Landroid/content/Context;Lcom/android/extrasettings/bluetooth/LocalBluetoothProfile;)V
    ...
    :cond_1
    instance-of v5, p1, Lcom/android/extrasettings/bluetooth/MapProfile;
    ...
    invoke-virtual {v5, v3}, Lcom/android/extrasettings/bluetooth/CachedBluetoothDevice;->setMessagePermissionChoice(I)V
    ...
    .line 255
    instance-of v3, p1, Lcom/android/extrasettings/bluetooth/PanProfile;
    ...
    invoke-virtual {v3, p1}, Lcom/android/extrasettings/bluetooth/CachedBluetoothDevice;->connectProfile(Lcom/android/extrasettings/bluetooth/LocalBluetoothProfile;)V

    goto :goto_1

    .line 246
    :cond_3
    instance-of v5, p1, Lcom/android/extrasettings/bluetooth/PbapServerProfile;
    ...
    invoke-virtual {v3, v4}, Lcom/android/extrasettings/bluetooth/CachedBluetoothDevice;->setPhonebookPermissionChoice(I)V
...
.method private refreshProfilePreference(Landroid/preference/CheckBoxPreference;Lcom/android/extrasettings/bluetooth/LocalBluetoothProfile;)V
    ...
    .line 370
    :goto_2
    invoke-interface {p2, v0}, Lcom/android/extrasettings/bluetooth/LocalBluetoothProfile;->getSummaryResourceForDevice(Landroid/bluetooth/BluetoothDevice;)I
    ...
    .line 364
    :cond_4
    instance-of v1, p2, Lcom/android/extrasettings/bluetooth/PanProfile;

    if-eqz v1, :cond_6

    .line 365
    invoke-interface {p2, v0}, Lcom/android/extrasettings/bluetooth/LocalBluetoothProfile;->getConnectionStatus(Landroid/bluetooth/BluetoothDevice;)I
...
.method private refreshProfiles()V
    ...
    invoke-virtual {v4}, Lcom/android/extrasettings/bluetooth/CachedBluetoothDevice;->getConnectableProfiles()Ljava/util/List;
    ...
    invoke-virtual {p0, v4}, Lcom/android/extrasettings/bluetooth/DeviceProfilesSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    .line 327
    invoke-direct {p0, v2}, Lcom/android/extrasettings/bluetooth/DeviceProfilesSettings;->createProfilePreference(Lcom/android/extrasettings/bluetooth/LocalBluetoothProfile;)Landroid/preference/CheckBoxPreference;

    move-result-object v3

    .line 328
    iget-object v4, p0, Lcom/android/extrasettings/bluetooth/DeviceProfilesSettings;->mProfileContainer:Landroid/preference/PreferenceGroup;
    ...
    .line 330
    :cond_0
    invoke-direct {p0, v3, v2}, Lcom/android/extrasettings/bluetooth/DeviceProfilesSettings;->refreshProfilePreference(Landroid/preference/CheckBoxPreference;Lcom/android/extrasettings/bluetooth/LocalBluetoothProfile;)V
    ...
    invoke-virtual {v4}, Lcom/android/extrasettings/bluetooth/CachedBluetoothDevice;->getRemovedProfiles()Ljava/util/List;
    ...
    .line 335
    .restart local v2    # "profile":Lcom/android/extrasettings/bluetooth/LocalBluetoothProfile;
    invoke-virtual {v2}, Ljava/lang/Object;->toString()Ljava/lang/String;
    ...
    .line 337
    instance-of v4, v2, Lcom/android/extrasettings/bluetooth/PbapServerProfile;
    ...
    invoke-virtual {v4}, Lcom/android/extrasettings/bluetooth/CachedBluetoothDevice;->getPhonebookPermissionChoice()I
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1, p2}, Lcom/android/extrasettings/bluetooth/CachedBluetoothDevice;->setAliasName(Ljava/lang/String;)V
