...
.method static synthetic access$000(Lcom/android/extrasettings/deviceinfo/Memory;)Ljava/util/ArrayList;
    .locals 1
...
.method static synthetic access$100(Lcom/android/extrasettings/deviceinfo/Memory;)Landroid/hardware/usb/UsbManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/deviceinfo/Memory;
...
.method static synthetic access$200(Lcom/android/extrasettings/deviceinfo/Memory;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/extrasettings/deviceinfo/Memory;
...
.method private doUnmount()V
    ...
    .line 352
    iget-object v2, p0, Lcom/android/extrasettings/deviceinfo/Memory;->mStorageVolume:Landroid/os/storage/StorageVolume;
    ...
    invoke-static {v2, v3}, Lcom/android/extrasettings/MediaFormat;->isUsbStorage(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
    ...
    :try_start_0
    sget-object v2, Lcom/android/extrasettings/deviceinfo/Memory;->sLastClickedMountToggle:Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v3}, Lcom/android/extrasettings/deviceinfo/Memory;->getString(I)Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lcom/android/extrasettings/MediaFormat;->isUiccStorage(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
    ...
    invoke-direct {p0, v2}, Lcom/android/extrasettings/deviceinfo/Memory;->showDialogInner(I)V
...
.method private mount()V
    ...
    .line 423
    :try_start_0
    sget-object v1, Lcom/android/extrasettings/deviceinfo/Memory;->sClickedMountPoint:Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v8}, Lcom/android/extrasettings/deviceinfo/Memory;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v8

    check-cast v8, Landroid/hardware/usb/UsbManager;

    iput-object v8, p0, Lcom/android/extrasettings/deviceinfo/Memory;->mUsbManager:Landroid/hardware/usb/UsbManager;
    ...
    iput-object v8, p0, Lcom/android/extrasettings/deviceinfo/Memory;->mStorageManager:Landroid/os/storage/StorageManager;

    .line 99
    iget-object v8, p0, Lcom/android/extrasettings/deviceinfo/Memory;->mStorageManager:Landroid/os/storage/StorageManager;

    iget-object v9, p0, Lcom/android/extrasettings/deviceinfo/Memory;->mStorageListener:Landroid/os/storage/StorageEventListener;
    ...
    invoke-virtual {p0, v8}, Lcom/android/extrasettings/deviceinfo/Memory;->addPreferencesFromResource(I)V
    ...
    invoke-direct {p0, v8}, Lcom/android/extrasettings/deviceinfo/Memory;->addCategory(Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;)V
    ...
    invoke-static {v7, v1}, Lcom/android/extrasettings/MediaFormat;->isUiccStorage(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
    ...
    :cond_3
    invoke-static {v7, v1}, Lcom/android/extrasettings/MediaFormat;->isUsbStorage(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
    ...
    .line 130
    :cond_4
    invoke-static {v1, v7}, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->buildForPhysical(Landroid/content/Context;Landroid/os/storage/StorageVolume;)Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;
    ...
    invoke-virtual {p0, v8}, Lcom/android/extrasettings/deviceinfo/Memory;->setHasOptionsMenu(Z)V
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    iget-object v4, p0, Lcom/android/extrasettings/deviceinfo/Memory;->mStorageVolume:Landroid/os/storage/StorageVolume;

    invoke-virtual {p0}, Lcom/android/extrasettings/deviceinfo/Memory;->getActivity()Landroid/app/Activity;

    move-result-object v5

    invoke-static {v4, v5}, Lcom/android/extrasettings/MediaFormat;->isUsbStorage(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
    ...
    new-instance v5, Lcom/android/extrasettings/deviceinfo/Memory$3;

    invoke-direct {v5, p0}, Lcom/android/extrasettings/deviceinfo/Memory$3;-><init>(Lcom/android/extrasettings/deviceinfo/Memory;)V
    ...
    invoke-static {v4, v5}, Lcom/android/extrasettings/MediaFormat;->isUiccStorage(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 267
    iput-object v5, p0, Lcom/android/extrasettings/deviceinfo/Memory;->mStorageVolume:Landroid/os/storage/StorageVolume;
    ...
    .line 274
    :cond_5
    invoke-direct {p0}, Lcom/android/extrasettings/deviceinfo/Memory;->mount()V
