...
.method public constructor <init>()V
    ...
    .line 402
    new-instance v0, Lcom/android/extrasettings/deviceinfo/SimStatus$3;

    invoke-direct {v0, p0}, Lcom/android/extrasettings/deviceinfo/SimStatus$3;-><init>(Lcom/android/extrasettings/deviceinfo/SimStatus;)V

    iput-object v0, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mTabListener:Landroid/widget/TabHost$OnTabChangeListener;

    .line 425
    new-instance v0, Lcom/android/extrasettings/deviceinfo/SimStatus$4;

    invoke-direct {v0, p0}, Lcom/android/extrasettings/deviceinfo/SimStatus$4;-><init>(Lcom/android/extrasettings/deviceinfo/SimStatus;)V

    iput-object v0, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mEmptyTabContent:Landroid/widget/TabHost$TabContentFactory;
...
.method static synthetic access$002(Lcom/android/extrasettings/deviceinfo/SimStatus;Landroid/telephony/SubscriptionInfo;)Landroid/telephony/SubscriptionInfo;
    .locals 0
    .param p0, "x0"    # Lcom/android/extrasettings/deviceinfo/SimStatus;
    ...
    .prologue
    .line 69
    iput-object p1, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mSir:Landroid/telephony/SubscriptionInfo;
...
.method static synthetic access$1000(Lcom/android/extrasettings/deviceinfo/SimStatus;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/extrasettings/deviceinfo/SimStatus;

    .prologue
    .line 69
    invoke-direct {p0}, Lcom/android/extrasettings/deviceinfo/SimStatus;->handleRadioStatus()V

    return-void
.end method

.method static synthetic access$1100(Lcom/android/extrasettings/deviceinfo/SimStatus;)Landroid/widget/TabHost;
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/deviceinfo/SimStatus;

    .prologue
    .line 69
    iget-object v0, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mTabHost:Landroid/widget/TabHost;
...
.method static synthetic access$500(Lcom/android/extrasettings/deviceinfo/SimStatus;)Ljava/util/List;
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/deviceinfo/SimStatus;

    .prologue
    .line 69
    iget-object v0, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mSelectableSubInfos:Ljava/util/List;

    return-object v0
.end method

.method static synthetic access$600(Lcom/android/extrasettings/deviceinfo/SimStatus;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/extrasettings/deviceinfo/SimStatus;
...
.method static synthetic access$700(Lcom/android/extrasettings/deviceinfo/SimStatus;)Landroid/telephony/PhoneStateListener;
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/deviceinfo/SimStatus;

    .prologue
    .line 69
    iget-object v0, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mPhoneStateListener:Landroid/telephony/PhoneStateListener;

    return-object v0
.end method

.method static synthetic access$800(Lcom/android/extrasettings/deviceinfo/SimStatus;)Landroid/telephony/TelephonyManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/deviceinfo/SimStatus;
...
.method static synthetic access$900(Lcom/android/extrasettings/deviceinfo/SimStatus;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/extrasettings/deviceinfo/SimStatus;
...
.method private buildTabSpec(Ljava/lang/String;Ljava/lang/String;)Landroid/widget/TabHost$TabSpec;
    ...
    iget-object v1, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mEmptyTabContent:Landroid/widget/TabHost$TabContentFactory;
...
.method private updateNetworkType()V
    ...
    .line 248
    .local v3, "subId":I
    iget-object v4, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mTelephonyManager:Landroid/telephony/TelephonyManager;

    iget-object v5, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mSir:Landroid/telephony/SubscriptionInfo;
    ...
    invoke-direct {p0, v4, v2}, Lcom/android/extrasettings/deviceinfo/SimStatus;->setSummaryText(Ljava/lang/String;Ljava/lang/String;)V
...
.method private updatePreference()V
    ...
    .line 345
    iget-object v3, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mPhone:Lcom/android/internal/telephony/Phone;
    ...
    iput-boolean v3, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mShowLatestAreaInfo:Z
    ...
    invoke-direct {p0, v3, v0}, Lcom/android/extrasettings/deviceinfo/SimStatus;->setSummaryText(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v3, v1}, Lcom/android/extrasettings/deviceinfo/SimStatus;->setSummaryText(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v3, v4}, Lcom/android/extrasettings/deviceinfo/SimStatus;->setSummaryText(Ljava/lang/String;Ljava/lang/String;)V

    .line 365
    iget-boolean v3, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mShowLatestAreaInfo:Z
    ...
    invoke-direct {p0, v3}, Lcom/android/extrasettings/deviceinfo/SimStatus;->removePreferenceFromScreen(Ljava/lang/String;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v2, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mSelectableSubInfos:Ljava/util/List;

    .line 140
    const-string v2, "phone"

    invoke-virtual {p0, v2}, Lcom/android/extrasettings/deviceinfo/SimStatus;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/telephony/TelephonyManager;

    iput-object v2, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mTelephonyManager:Landroid/telephony/TelephonyManager;

    .line 142
    const v2, 0x7f06001c

    invoke-virtual {p0, v2}, Lcom/android/extrasettings/deviceinfo/SimStatus;->addPreferencesFromResource(I)V
    ...
    iput-object v2, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mRes:Landroid/content/res/Resources;
    ...
    iput-object v2, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mDefaultText:Ljava/lang/String;

    .line 147
    const-string v2, "signal_strength"

    invoke-virtual {p0, v2}, Lcom/android/extrasettings/deviceinfo/SimStatus;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v2

    iput-object v2, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mSignalStrength:Landroid/preference/Preference;
    ...
    .line 152
    iget-object v2, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mSelectableSubInfos:Ljava/util/List;
    ...
    :goto_1
    iput-object v2, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mSir:Landroid/telephony/SubscriptionInfo;
    ...
    invoke-virtual {p0, v2}, Lcom/android/extrasettings/deviceinfo/SimStatus;->setContentView(I)V

    .line 160
    const v2, 0x1020012

    invoke-virtual {p0, v2}, Lcom/android/extrasettings/deviceinfo/SimStatus;->findViewById(I)Landroid/view/View;

    move-result-object v2

    check-cast v2, Landroid/widget/TabHost;

    iput-object v2, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mTabHost:Landroid/widget/TabHost;
    ...
    iput-object v2, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mTabWidget:Landroid/widget/TabWidget;
    ...
    iput-object v2, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mListView:Landroid/widget/ListView;

    .line 164
    iget-object v2, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mTabHost:Landroid/widget/TabHost;
    ...
    iget-object v3, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mTabListener:Landroid/widget/TabHost$OnTabChangeListener;
    ...
    .line 169
    iget-object v3, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mTabHost:Landroid/widget/TabHost;
    ...
    invoke-direct {p0, v4, v2}, Lcom/android/extrasettings/deviceinfo/SimStatus;->buildTabSpec(Ljava/lang/String;Ljava/lang/String;)Landroid/widget/TabHost$TabSpec;
    ...
    iput-object v2, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mSimHotSwapHandler:Lcom/mediatek/settings/sim/SimHotSwapHandler;

    .line 177
    iget-object v2, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mSimHotSwapHandler:Lcom/mediatek/settings/sim/SimHotSwapHandler;
...
.method protected onDestroy()V
    ...
    .line 441
    iget-object v0, p0, Lcom/android/extrasettings/deviceinfo/SimStatus;->mSimHotSwapHandler:Lcom/mediatek/settings/sim/SimHotSwapHandler;
