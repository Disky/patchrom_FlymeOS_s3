...
.implements Lcom/android/extrasettings/deviceinfo/UsageBarPreference$OnRequestMediaRescanListener;
...
.method private constructor <init>(Landroid/content/Context;Landroid/os/storage/StorageVolume;)V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mIsInternal:Z
    ...
    :cond_0
    iput-boolean v1, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mIsPrimary:Z
    ...
    :goto_1
    invoke-virtual {p0, v0}, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->setTitle(Ljava/lang/CharSequence;)V
...
.method static synthetic access$000(Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;)Lcom/android/extrasettings/deviceinfo/UsageBarPreference;
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;

    .prologue
    .line 57
    iget-object v0, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mUsageBarPreference:Lcom/android/extrasettings/deviceinfo/UsageBarPreference;

    return-object v0
.end method

.method static synthetic access$100(Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;
...
.method private measure()V
    ...
    invoke-virtual {v0}, Lcom/android/extrasettings/deviceinfo/UsageBarPreference;->onMeasure()V
...
.method private updatePreferencesFromState()V
    ...
    iget-object v4, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mMountTogglePreference:Landroid/preference/Preference;

    invoke-virtual {v4, v7}, Landroid/preference/Preference;->setEnabled(Z)V

    .line 328
    iget-object v4, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mStorageManager:Landroid/os/storage/StorageManager;

    iget-object v5, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mVolume:Landroid/os/storage/StorageVolume;
    ...
    .line 331
    iget-object v4, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mItemAvailable:Lcom/android/extrasettings/deviceinfo/StorageItemPreference;

    const v5, 0x7f09076a

    invoke-virtual {v4, v5}, Lcom/android/extrasettings/deviceinfo/StorageItemPreference;->setTitle(I)V
    ...
    invoke-static {v4, v0}, Lcom/android/extrasettings/MediaFormat;->isUsbStorage(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
    ...
    .line 356
    iget-object v4, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mUsageBarPreference:Lcom/android/extrasettings/deviceinfo/UsageBarPreference;

    invoke-virtual {p0, v4}, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->addPreference(Landroid/preference/Preference;)Z

    .line 357
    iget-object v4, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mItemTotal:Lcom/android/extrasettings/deviceinfo/StorageItemPreference;
    ...
    .line 405
    :goto_3
    iget-boolean v4, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mUsbConnected:Z

    if-eqz v4, :cond_10

    const-string v4, "mtp"

    iget-object v5, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mUsbFunction:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mResources:Landroid/content/res/Resources;
    ...
    .line 414
    :cond_5
    iget-object v4, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mFormatPreference:Landroid/preference/Preference;
    ...
    invoke-static {v4, v0}, Lcom/android/extrasettings/MediaFormat;->isUiccStorage(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, v4}, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->removePreference(Landroid/preference/Preference;)Z
    ...
    iget-object v5, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mMountTogglePreference:Landroid/preference/Preference;
...
.method public init()V
    ...
    invoke-direct {v0, v10}, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->getUsersExcluding(Landroid/content/pm/UserInfo;)Ljava/util/List;
    ...
    iget-boolean v0, v0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mIsInternal:Z
    ...
    iget-boolean v0, v0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mIsPrimary:Z
    ...
    :cond_2
    :goto_1
    new-instance v23, Lcom/android/extrasettings/deviceinfo/UsageBarPreference;

    move-object/from16 v0, v23

    invoke-direct {v0, v7}, Lcom/android/extrasettings/deviceinfo/UsageBarPreference;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual/range {v23 .. v24}, Lcom/android/extrasettings/deviceinfo/UsageBarPreference;->setOrder(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/extrasettings/deviceinfo/UsageBarPreference;->setOnRequestMediaRescanListener(Lcom/android/extrasettings/deviceinfo/UsageBarPreference$OnRequestMediaRescanListener;)V
    ...
    invoke-virtual {v0, v5}, Lcom/android/extrasettings/deviceinfo/UsageBarPreference;->setAllowMediaScan(Z)V
    ...
    invoke-virtual/range {v23 .. v24}, Lcom/android/extrasettings/deviceinfo/StorageItemPreference;->setKey(Ljava/lang/String;)V
    ...
    .line 205
    new-instance v23, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory$PreferenceHeader;
    ...
    invoke-direct {v0, v7, v1}, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory$PreferenceHeader;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;)V
    ...
    const v24, 0x7f09078f

    move-object/from16 v0, v23

    move/from16 v1, v24

    invoke-direct {v0, v7, v1}, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory$PreferenceHeader;-><init>(Landroid/content/Context;I)V
    ...
    .local v6, "colorRes":I
    :goto_4
    new-instance v22, Lcom/android/extrasettings/deviceinfo/StorageItemPreference;
    ...
    invoke-direct {v0, v1, v2, v6, v3}, Lcom/android/extrasettings/deviceinfo/StorageItemPreference;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;II)V

    .line 224
    .local v22, "userPref":Lcom/android/extrasettings/deviceinfo/StorageItemPreference;
    move-object/from16 v0, p0
    ...
    .end local v22    # "userPref":Lcom/android/extrasettings/deviceinfo/StorageItemPreference;
    :catch_0
    move-exception v11
    ...
    invoke-static {v0, v7}, Lcom/android/extrasettings/MediaFormat;->isUsbStorage(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
    ...
    invoke-static {v0, v7}, Lcom/android/extrasettings/MediaFormat;->isUiccStorage(Landroid/os/storage/StorageVolume;Landroid/content/Context;)Z
    ...
    iget-object v0, v0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mResources:Landroid/content/res/Resources;
...
.method public intentForClick(Landroid/preference/Preference;)Landroid/content/Intent;
    ...
    iget-object v2, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mFormatPreference:Landroid/preference/Preference;
    ...
    const-class v3, Lcom/android/extrasettings/MediaFormat;
    ...
    .line 569
    :cond_1
    iget-object v2, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mItemApps:Lcom/android/extrasettings/deviceinfo/StorageItemPreference;
    ...
    const-class v3, Lcom/android/extrasettings/Settings$ManageApplicationsActivity;
    ...
    .line 572
    :cond_2
    iget-object v2, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mItemDownloads:Lcom/android/extrasettings/deviceinfo/StorageItemPreference;
    ...
    .line 575
    :cond_3
    iget-object v2, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mItemMusic:Lcom/android/extrasettings/deviceinfo/StorageItemPreference;
    ...
    .line 578
    :cond_4
    iget-object v2, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mItemDcim:Lcom/android/extrasettings/deviceinfo/StorageItemPreference;
    ...
    .line 583
    :cond_5
    iget-object v2, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mItemMisc:Lcom/android/extrasettings/deviceinfo/StorageItemPreference;
    ...
    .end local v1    # "intent":Landroid/content/Intent;
    const-class v2, Lcom/android/extrasettings/deviceinfo/MiscFilesHandler;
...
.method public onRequestMediaRescan()V
    ...
    iget-boolean v1, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mIsInternal:Z
    ...
    :cond_0
    iget-boolean v1, p0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mIsPrimary:Z
...
.method public updateDetails(Lcom/android/extrasettings/deviceinfo/StorageMeasurement$MeasurementDetails;)V
    ...
    iget-object v11, v0, Lcom/android/extrasettings/deviceinfo/StorageVolumePreferenceCategory;->mUpdateHandler:Landroid/os/Handler;
