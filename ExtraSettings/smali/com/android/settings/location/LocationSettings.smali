...
.method private createPreferenceHierarchy()Landroid/preference/PreferenceScreen;
    ...
    iput-object v6, p0, Lcom/android/extrasettings/location/LocationSettings;->mLtoDownloadDataWifiOnly:Landroid/preference/SwitchPreference;

    .line 181
    iget-object v6, p0, Lcom/android/extrasettings/location/LocationSettings;->mLtoDownloadDataWifiOnly:Landroid/preference/SwitchPreference;

    if-eqz v6, :cond_2

    .line 182
    invoke-static {v0}, Lcom/android/extrasettings/location/LocationSettings;->isLtoSupported(Landroid/content/Context;)Z

    move-result v6

    if-eqz v6, :cond_1

    invoke-static {v0}, Lcom/android/extrasettings/location/LocationSettings;->checkGpsDownloadWiFiOnly(Landroid/content/Context;)Z
    ...
    .end local v3    # "recentApps":Lcom/android/extrasettings/location/RecentLocationApps;
    ...
    .line 198
    .restart local v3    # "recentApps":Lcom/android/extrasettings/location/RecentLocationApps;
...
.method public static restore(Landroid/content/Context;)V
    ...
    .prologue
    .line 401
    invoke-static {p0}, Lcom/android/extrasettings/location/LocationSettings;->isLtoSupported(Landroid/content/Context;)Z
    ...
    .line 403
    invoke-static {p0}, Lcom/android/extrasettings/location/LocationSettings;->checkGpsDownloadWiFiOnly(Landroid/content/Context;)Z
...
.method private static updateLtoServiceStatus(Landroid/content/Context;Z)V
    ...
    const-class v1, Lcom/android/extrasettings/cyanogenmod/LtoService;
...
.method public onModeChanged(IZ)V
    ...
    .line 311
    iget-object v3, p0, Lcom/android/extrasettings/location/LocationSettings;->mLtoDownloadDataWifiOnly:Landroid/preference/SwitchPreference;

    if-eqz v3, :cond_0

    .line 312
    iget-object v4, p0, Lcom/android/extrasettings/location/LocationSettings;->mLtoDownloadDataWifiOnly:Landroid/preference/SwitchPreference;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .prologue
    .line 360
    iget-object v0, p0, Lcom/android/extrasettings/location/LocationSettings;->mLtoDownloadDataWifiOnly:Landroid/preference/SwitchPreference;
    ...
    invoke-static {v1}, Lcom/android/extrasettings/location/LocationSettings;->isLocationModeEnabled(Landroid/content/Context;)Z

    move-result v1

    invoke-static {v0, v1}, Lcom/android/extrasettings/location/LocationSettings;->updateLtoServiceStatus(Landroid/content/Context;Z)V
