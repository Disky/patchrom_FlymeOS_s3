.class public Lcom/android/extrasettings/location/RecentLocationApps;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/extrasettings/location/RecentLocationApps$PackageEntryClickedListener;
    }
.end annotation
...
# instance fields
.field private final mActivity:Lcom/android/extrasettings/SettingsActivity;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 48
    const-class v0, Lcom/android/extrasettings/location/RecentLocationApps;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/extrasettings/location/RecentLocationApps;->TAG:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Lcom/android/extrasettings/SettingsActivity;)V
    .locals 1
    .param p1, "activity"    # Lcom/android/extrasettings/SettingsActivity;
    ...
    .line 57
    iput-object p1, p0, Lcom/android/extrasettings/location/RecentLocationApps;->mActivity:Lcom/android/extrasettings/SettingsActivity;

    .line 58
    invoke-virtual {p1}, Lcom/android/extrasettings/SettingsActivity;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v0

    iput-object v0, p0, Lcom/android/extrasettings/location/RecentLocationApps;->mPackageManager:Landroid/content/pm/PackageManager;

    .line 59
    return-void
.end method

.method static synthetic access$000(Lcom/android/extrasettings/location/RecentLocationApps;)Lcom/android/extrasettings/SettingsActivity;
    .locals 1
    .param p0, "x0"    # Lcom/android/extrasettings/location/RecentLocationApps;

    .prologue
    .line 47
    iget-object v0, p0, Lcom/android/extrasettings/location/RecentLocationApps;->mActivity:Lcom/android/extrasettings/SettingsActivity;

    return-object v0
.end method

.method private createRecentLocationEntry(Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/preference/Preference$OnPreferenceClickListener;)Lcom/android/extrasettings/location/DimmableIconPreference;
    .locals 2
    ...
    .prologue
    .line 88
    new-instance v0, Lcom/android/extrasettings/location/DimmableIconPreference;

    iget-object v1, p0, Lcom/android/extrasettings/location/RecentLocationApps;->mActivity:Lcom/android/extrasettings/SettingsActivity;

    invoke-direct {v0, v1, p4}, Lcom/android/extrasettings/location/DimmableIconPreference;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;)V

    .line 89
    .local v0, "pref":Lcom/android/extrasettings/location/DimmableIconPreference;
    invoke-virtual {v0, p1}, Lcom/android/extrasettings/location/DimmableIconPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V

    .line 90
    invoke-virtual {v0, p2}, Lcom/android/extrasettings/location/DimmableIconPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/extrasettings/location/DimmableIconPreference;->setSummary(I)V

    .line 96
    :goto_0
    invoke-virtual {v0, p5}, Lcom/android/extrasettings/location/DimmableIconPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V
...
.method private getPreferenceFromOps(Landroid/os/UserManager;JLandroid/app/AppOpsManager$PackageOps;)Landroid/preference/Preference;
    ...
    .line 170
    sget-object v4, Lcom/android/extrasettings/location/RecentLocationApps;->TAG:Ljava/lang/String;
    ...
    .line 183
    .local v19, "preference":Lcom/android/extrasettings/location/DimmableIconPreference;
    :try_start_0
    ...
    iget-object v4, v0, Lcom/android/extrasettings/location/RecentLocationApps;->mActivity:Lcom/android/extrasettings/SettingsActivity;

    invoke-virtual {v4}, Lcom/android/extrasettings/SettingsActivity;->getResources()Landroid/content/res/Resources;
    ...
    iget-object v4, v0, Lcom/android/extrasettings/location/RecentLocationApps;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    .line 203
    :cond_6
    new-instance v9, Lcom/android/extrasettings/location/RecentLocationApps$PackageEntryClickedListener;
    ...
    invoke-direct {v9, v0, v1, v2}, Lcom/android/extrasettings/location/RecentLocationApps$PackageEntryClickedListener;-><init>(Lcom/android/extrasettings/location/RecentLocationApps;Ljava/lang/String;Landroid/os/UserHandle;)V

    move-object/from16 v4, p0

    invoke-direct/range {v4 .. v9}, Lcom/android/extrasettings/location/RecentLocationApps;->createRecentLocationEntry(Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/preference/Preference$OnPreferenceClickListener;)Lcom/android/extrasettings/location/DimmableIconPreference;
    :try_end_0
...
.method public getAppList()Ljava/util/List;
    ...
    iget-object v0, v0, Lcom/android/extrasettings/location/RecentLocationApps;->mActivity:Lcom/android/extrasettings/SettingsActivity;

    move-object/from16 v17, v0

    const-string v18, "appops"

    invoke-virtual/range {v17 .. v18}, Lcom/android/extrasettings/SettingsActivity;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v15, v8, v9, v7}, Lcom/android/extrasettings/location/RecentLocationApps;->getPreferenceFromOps(Landroid/os/UserManager;JLandroid/app/AppOpsManager$PackageOps;)Landroid/preference/Preference;
