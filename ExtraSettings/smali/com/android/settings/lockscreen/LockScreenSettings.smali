.class public Lcom/android/extrasettings/lockscreen/LockScreenSettings;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/extrasettings/lockscreen/LockScreenSettings$LockScreenSearchIndexProvider;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->SWITCH_PREFERENCE_KEYS:[Ljava/lang/String;

    .line 540
    new-instance v0, Lcom/android/extrasettings/lockscreen/LockScreenSettings$LockScreenSearchIndexProvider;

    invoke-direct {v0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings$LockScreenSearchIndexProvider;-><init>()V

    sput-object v0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->SEARCH_INDEX_DATA_PROVIDER:Lcom/android/extrasettings/search/Indexable$SearchIndexProvider;
...
.method static synthetic access$000(Landroid/content/Context;Lcom/android/internal/widget/LockPatternUtils;)I
    ...
    .prologue
    .line 59
    invoke-static {p0, p1}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->getResIdForLockUnlockScreen(Landroid/content/Context;Lcom/android/internal/widget/LockPatternUtils;)I
...
.method private createPreferenceHierarchy()V
    ...
    .prologue
    .line 155
    invoke-virtual/range {p0 .. p0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    invoke-virtual {v0, v1}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->addPreferencesFromResource(I)V
    ...
    .line 163
    invoke-virtual/range {p0 .. p0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v11

    .line 166
    .local v11, "pm":Landroid/content/pm/PackageManager;
    invoke-virtual/range {p0 .. p0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->getActivity()Landroid/app/Activity;

    move-result-object v19

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    move-object/from16 v20, v0

    invoke-static/range {v19 .. v20}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->getResIdForLockUnlockScreen(Landroid/content/Context;Lcom/android/internal/widget/LockPatternUtils;)I
    ...
    invoke-virtual {v0, v13}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->addPreferencesFromResource(I)V
    ...
    iput-boolean v0, v1, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mIsPrimary:Z

    .line 172
    move-object/from16 v0, p0

    iget-boolean v0, v0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mIsPrimary:Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    iput-object v0, v1, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mLockAfter:Landroid/preference/ListPreference;

    .line 195
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mLockAfter:Landroid/preference/ListPreference;
    ...
    .line 196
    invoke-direct/range {p0 .. p0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->setupLockAfterPreference()V

    .line 197
    invoke-direct/range {p0 .. p0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->updateLockAfterPreferenceSummary()V
    ...
    iput-object v0, v1, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mBiometricWeakLiveliness:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, v1, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mVisiblePattern:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, v1, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mVisibleErrorPattern:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, v1, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mDirectlyShow:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, v1, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mVisibleDots:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, v1, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mPowerButtonInstantlyLocks:Landroid/preference/SwitchPreference;

    .line 219
    invoke-direct/range {p0 .. p0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->getActiveTrustAgentTitle()Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mPowerButtonInstantlyLocks:Landroid/preference/SwitchPreference;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mVisiblePattern:Landroid/preference/SwitchPreference;
    ...
    iget-object v0, v0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mVisibleErrorPattern:Landroid/preference/SwitchPreference;
    ...
    iget-object v0, v0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mVisibleDots:Landroid/preference/SwitchPreference;
    ...
    invoke-static/range {v19 .. v20}, Lcom/android/extrasettings/SecuritySettings;->getActiveTrustAgents(Landroid/content/pm/PackageManager;Lcom/android/internal/widget/LockPatternUtils;)Ljava/util/ArrayList;

    move-result-object v4

    .line 258
    .local v4, "agents":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/extrasettings/TrustAgentUtils$TrustAgentComponentInfo;>;"
    const/4 v8, 0x0
    ...
    check-cast v3, Lcom/android/extrasettings/TrustAgentUtils$TrustAgentComponentInfo;

    .line 260
    .local v3, "agent":Lcom/android/extrasettings/TrustAgentUtils$TrustAgentComponentInfo;
    ...
    .line 263
    iget-object v0, v3, Lcom/android/extrasettings/TrustAgentUtils$TrustAgentComponentInfo;->title:Ljava/lang/String;
    ...
    .line 264
    iget-object v0, v3, Lcom/android/extrasettings/TrustAgentUtils$TrustAgentComponentInfo;->summary:Ljava/lang/String;
    ...
    iget-object v0, v3, Lcom/android/extrasettings/TrustAgentUtils$TrustAgentComponentInfo;->componentName:Landroid/content/ComponentName;
    ...
    .line 170
    .end local v3    # "agent":Lcom/android/extrasettings/TrustAgentUtils$TrustAgentComponentInfo;
    .end local v4    # "agents":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/extrasettings/TrustAgentUtils$TrustAgentComponentInfo;>;"
    ...
    :goto_3
    sget-object v19, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->SWITCH_PREFERENCE_KEYS:[Ljava/lang/String;
...
.method private disableUnusableTimeouts(J)V
    ...
    .prologue
    .line 379
    iget-object v8, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mLockAfter:Landroid/preference/ListPreference;
    ...
    .line 391
    :cond_2
    iget-object v9, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mLockAfter:Landroid/preference/ListPreference;
...
.method private getActiveTrustAgentTitle()Ljava/lang/String;
    ...
    .prologue
    .line 286
    iget-object v4, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    invoke-virtual {p0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v4

    iget-object v5, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    invoke-static {v4, v5}, Lcom/android/extrasettings/SecuritySettings;->getActiveTrustAgents(Landroid/content/pm/PackageManager;Lcom/android/internal/widget/LockPatternUtils;)Ljava/util/ArrayList;

    move-result-object v1

    .line 289
    .local v1, "agents":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/extrasettings/TrustAgentUtils$TrustAgentComponentInfo;>;"
    const/4 v3, 0x0
    ...
    check-cast v0, Lcom/android/extrasettings/TrustAgentUtils$TrustAgentComponentInfo;

    .line 291
    .local v0, "agent":Lcom/android/extrasettings/TrustAgentUtils$TrustAgentComponentInfo;
    iget-object v4, v0, Lcom/android/extrasettings/TrustAgentUtils$TrustAgentComponentInfo;->title:Ljava/lang/String;
    ...
    .line 296
    .end local v0    # "agent":Lcom/android/extrasettings/TrustAgentUtils$TrustAgentComponentInfo;
    :goto_1
    return-object v4

    .line 289
    .restart local v0    # "agent":Lcom/android/extrasettings/TrustAgentUtils$TrustAgentComponentInfo;
    :cond_0
...
.method private setupLockAfterPreference()V
    ...
    .line 340
    invoke-virtual {p0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->getContentResolver()Landroid/content/ContentResolver;
    ...
    .line 344
    iget-object v8, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    invoke-direct {p0, v6, v7}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->disableUnusableTimeouts(J)V
...
.method private updateLockAfterPreferenceSummary()V
    ...
    :cond_1
    invoke-direct {p0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->getActiveTrustAgentTitle()Ljava/lang/String;
    ...
    invoke-virtual {p0, v10, v11}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 419
    invoke-virtual {p0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->startBiometricWeakImprove()V
    ...
    .line 423
    iget-object v1, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mChooseLockSettingsHelper:Lcom/android/extrasettings/ChooseLockSettingsHelper;
    ...
    .line 430
    iget-object v1, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mTrustAgentClickIntent:Landroid/content/Intent;
    ...
    invoke-virtual {p0, v1}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->startActivity(Landroid/content/Intent;)V

    .line 432
    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mTrustAgentClickIntent:Landroid/content/Intent;
    ...
    .line 436
    invoke-virtual {p0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->getActivity()Landroid/app/Activity;
    ...
    const-class v2, Lcom/android/extrasettings/lockscreen/LockScreenSettings;

    invoke-virtual {v2}, Ljava/lang/Class;->getName()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2, v3, v3}, Lcom/android/extrasettings/search/Index;->updateFromClassNameResource(Ljava/lang/String;ZZ)V

    .line 440
    :cond_4
    invoke-direct {p0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->createPreferenceHierarchy()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    iput-object v0, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mChooseLockSettingsHelper:Lcom/android/extrasettings/ChooseLockSettingsHelper;
    ...
    iput-object v0, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mTrustAgentClickIntent:Landroid/content/Intent;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget-object v6, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mChooseLockSettingsHelper:Lcom/android/extrasettings/ChooseLockSettingsHelper;

    invoke-virtual {v6}, Lcom/android/extrasettings/ChooseLockSettingsHelper;->utils()Lcom/android/internal/widget/LockPatternUtils;
    ...
    .line 456
    :goto_0
    invoke-direct {p0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->updateLockAfterPreferenceSummary()V
    ...
    .line 474
    :cond_7
    iget-object v6, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mBiometricWeakLiveliness:Landroid/preference/SwitchPreference;
    ...
    .line 488
    iget-object v6, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->startFragment(Landroid/app/Fragment;Ljava/lang/String;IILandroid/os/Bundle;)Z
    ...
    invoke-static {v0, v1, v9, v9}, Lcom/android/extrasettings/ManageFingerprints;->createIntent(Landroid/content/Context;ZZZ)Landroid/content/Intent;

    move-result-object v7

    .line 501
    .local v7, "intent":Landroid/content/Intent;
    invoke-virtual {p0, v7}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->startActivity(Landroid/content/Intent;)V
    ...
    iget-object v0, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mTrustAgentClickIntent:Landroid/content/Intent;
    ...
    invoke-virtual {p0, v0}, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->startActivity(Landroid/content/Intent;)V

    .line 521
    iput-object v5, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mTrustAgentClickIntent:Landroid/content/Intent;
...
.method public onResume()V
    ...
    .line 133
    .local v0, "lockPatternUtils":Lcom/android/internal/widget/LockPatternUtils;
    iget-object v1, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mBiometricWeakLiveliness:Landroid/preference/SwitchPreference;
    ...
    .line 137
    :cond_0
    iget-object v1, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mVisiblePattern:Landroid/preference/SwitchPreference;
    ...
    .line 140
    :cond_1
    iget-object v1, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mVisibleErrorPattern:Landroid/preference/SwitchPreference;
    ...
    .line 143
    :cond_2
    iget-object v1, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mDirectlyShow:Landroid/preference/SwitchPreference;
    ...
    .line 146
    :cond_3
    iget-object v1, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mVisibleDots:Landroid/preference/SwitchPreference;
    ...
    .line 149
    :cond_4
    iget-object v1, p0, Lcom/android/extrasettings/lockscreen/LockScreenSettings;->mPowerButtonInstantlyLocks:Landroid/preference/SwitchPreference;
