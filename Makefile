...
#-----------------------------------------------------------------------------
vendor_remove_dirs := vendor/operator/app media/audio
...
vendor_saved_apps := Bluetooth KeyChain Tag HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
                     ...
                     ProxyHandler Shell DefaultContainerService WAPPushManager Stk CMSettingsProvider Nfc
...
#-----------------------------------------------------------------------------
board_remove_apps := LogReport Bluetooth NfcNci KeyChain Tag HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
                     FusedLocation PrintSpooler SharedStorageBackup  ExternalStorageProvider InputDevices \
...
override_property += \
    ...
    ro.product.model_romer=S3_Disky
