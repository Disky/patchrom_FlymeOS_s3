...
#-----------------------------------------------------------------------------
vendor_remove_dirs := usr/srec vendor/pittpatt vendor/operator/app media/audio
...
vendor_saved_apps := Bluetooth Nfc KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
                     ...
                     ProxyHandler Shell DefaultContainerService Stk1 EngineerMode As AsUI
...
#-----------------------------------------------------------------------------
board_remove_apps := LogReport Bluetooth NfcNci KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
                     FusedLocation PrintSpooler SharedStorageBackup  ExternalStorageProvider InputDevices \
                     ProxyHandler Shell DefaultContainerService TimeService qcrilmsgtunnel
...
override_property += \
    ro.flyme.romer=Disky \
    ro.product.model_romer=JY-S3_Disky
