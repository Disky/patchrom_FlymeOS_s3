...
.field mtakeScreenshot:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mShotScreenReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mtakeScreenshot:Landroid/content/BroadcastReceiver;
...
.method private applyLidSwitchState()V
    ...
    .line 6582
    .local v0, "telephonyService":Landroid/telecom/TelecomManager;
    if-eqz v0, :cond_0
    ...
    .line 6589
    .end local v0    # "telephonyService":Landroid/telecom/TelecomManager;
    :cond_0
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mWindowManagerInternal:Landroid/view/WindowManagerInternal;
    ...
    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDreamManagerInternal:Landroid/service/dreams/DreamManagerInternal;
    ...
    .line 1368
    new-instance v7, Lcom/android/internal/policy/impl/PhoneWindowManager$MyWakeGestureListener;
    ...
    invoke-direct {v7, p0, v8, v9}, Lcom/android/internal/policy/impl/PhoneWindowManager$MyWakeGestureListener;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/content/Context;Landroid/os/Handler;)V

    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mWakeGestureListener:Lcom/android/internal/policy/impl/PhoneWindowManager$MyWakeGestureListener;
    ...
    invoke-direct {v7, p0, v8, v9}, Lcom/android/internal/policy/impl/PhoneWindowManager$MyOrientationListener;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/content/Context;Landroid/os/Handler;)V
    ...
    const v8, #android:integer@config_defaultUiModeType#t
    ...
    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerKeyWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    const v8, #android:bool@config_supportAutoRotation#t

    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSupportAutoRotation:Z

    const v7, #android:integer@config_lidOpenRotation#t
    ...
    const v7, #android:integer@config_carDockRotation#t
    ...
    const v7, #android:integer@config_deskDockRotation#t
    ...
    const v7, #android:integer@config_undockedHdmiRotation#t

    invoke-direct {p0, v7}, Lcom/android/internal/policy/impl/PhoneWindowManager;->readRotation(I)I

    move-result v7

    iput v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mUndockedHdmiRotation:I
    ...
    const v8, #android:bool@config_carDockEnablesAccelerometer#t
    ...
    const v8, #android:bool@config_deskDockEnablesAccelerometer#t
    ...
    const v8, #android:integer@config_lidKeyboardAccessibility#t
    ...
    const v8, #android:integer@config_lidNavigationAccessibility#t
    ...
    const v8, #android:bool@config_lidControlsSleep#t
    ...
    const v8, #android:bool@config_enableTranslucentDecor#t

    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mTranslucentDecorEnabled:Z
    ...
    const v8, #android:integer@config_backKillTimeout#t

    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v7

    iput v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBackKillTimeout:I
    ...
    const v8, #android:bool@config_allowTheaterModeWakeFromKey#t

    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAllowTheaterModeWakeFromKey:Z

    .line 1425
    iget-boolean v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAllowTheaterModeWakeFromKey:Z
    ...
    const v8, #android:bool@config_allowTheaterModeWakeFromPowerKey#t
    ...
    :goto_1
    iput-boolean v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAllowTheaterModeWakeFromPowerKey:Z
    ...
    const v8, #android:bool@config_allowTheaterModeWakeFromMotion#t

    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAllowTheaterModeWakeFromMotion:Z
    ...
    const v8, #android:bool@config_allowTheaterModeWakeFromMotionWhenNotDreaming#t

    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAllowTheaterModeWakeFromMotionWhenNotDreaming:Z
    ...
    const v8, #android:bool@config_allowTheaterModeWakeFromCameraLens#t

    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAllowTheaterModeWakeFromCameraLens:Z
    ...
    const v8, #android:bool@config_allowTheaterModeWakeFromLidSwitch#t

    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAllowTheaterModeWakeFromLidSwitch:Z
    ...
    const v8, #android:bool@config_allowTheaterModeWakeFromGesture#t

    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAllowTheaterModeWakeFromWakeGesture:Z
    ...
    const v8, #android:bool@config_goToSleepOnButtonPressTheaterMode#t

    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mGoToSleepOnButtonPressTheaterMode:Z
    ...
    const v8, #android:integer@config_shortPressOnPowerBehavior#t

    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v7

    iput v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mShortPressOnPowerBehavior:I

    .line 1445
    iget-boolean v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mIsWearable:Z
    ...
    iput v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLongPressOnPowerBehavior:I
    ...
    const v8, #android:integer@config_doublePressOnPowerBehavior#t

    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v7

    iput v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDoublePressOnPowerBehavior:I
    ...
    const v8, #android:integer@config_triplePressOnPowerBehavior#t

    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v7

    iput v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mTriplePressOnPowerBehavior:I
    ...
    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAccessibilityManager:Landroid/view/accessibility/AccessibilityManager;
    ...
    .line 1478
    iget-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mIpoEventReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 1483
    .local v4, "poweroffAlarmFilter":Landroid/content/IntentFilter;
    ...
    .line 1485
    iget-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPoweroffAlarmReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 1490
    .local v5, "statusbarEventFilter":Landroid/content/IntentFilter;
    const-string v7, "com.mediatek.action.REQUEST_TRANSIENT_STATUSBAR"

    invoke-virtual {v5, v7}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 1491
    iget-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStatusBarEventReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 1496
    .local v6, "stkUserActivityFilter":Landroid/content/IntentFilter;
    const-string v7, "android.intent.action.stk.USER_ACTIVITY.enable"

    invoke-virtual {v6, v7}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 1497
    iget-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStkUserActivityEnReceiver:Landroid/content/BroadcastReceiver;
    ...
    .end local v0    # "filter":Landroid/content/IntentFilter;
    const-string v7, "com.v.ShotScreen"

    invoke-direct {v0, v7}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    .line 1513
    .restart local v0    # "filter":Landroid/content/IntentFilter;
    iget-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mShotScreenReceiver:Landroid/content/BroadcastReceiver;
    ...
    const-string v7, "android.intent.action.takeScreenshot"

    invoke-direct {v3, v7}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    .line 1521
    .local v3, "mfilter":Landroid/content/IntentFilter;
    iget-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mtakeScreenshot:Landroid/content/BroadcastReceiver;
    ...
    .line 1525
    new-instance v7, Lcom/android/internal/policy/impl/SystemGesturesPointerEventListener;

    new-instance v8, Lcom/android/internal/policy/impl/PhoneWindowManager$8;

    invoke-direct {v8, p0}, Lcom/android/internal/policy/impl/PhoneWindowManager$8;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;)V

    invoke-direct {v7, p1, v8}, Lcom/android/internal/policy/impl/SystemGesturesPointerEventListener;-><init>(Landroid/content/Context;Lcom/android/internal/policy/impl/SystemGesturesPointerEventListener$Callbacks;)V

    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSystemGestures:Lcom/android/internal/policy/impl/SystemGesturesPointerEventListener;

    .line 1564
    new-instance v7, Lcom/android/internal/policy/impl/ImmersiveModeConfirmation;

    iget-object v8, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mContext:Landroid/content/Context;

    invoke-direct {v7, v8}, Lcom/android/internal/policy/impl/ImmersiveModeConfirmation;-><init>(Landroid/content/Context;)V

    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mImmersiveModeConfirmation:Lcom/android/internal/policy/impl/ImmersiveModeConfirmation;
    ...
    iget-object v8, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSystemGestures:Lcom/android/internal/policy/impl/SystemGesturesPointerEventListener;
    ...
    const v8, #android:array@config_longPressVibePattern#t
    ...
    const v8, #android:array@config_virtualKeyVibePattern#t
    ...
    const v8, #android:array@config_keyboardTapVibePattern#t
    ...
    const v8, #android:array@config_clockTickVibePattern#t

    invoke-static {v7, v8}, Lcom/android/internal/policy/impl/PhoneWindowManager;->getLongIntArray(Landroid/content/res/Resources;I)[J

    move-result-object v7

    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mClockTickVibePattern:[J
    ...
    const v8, #android:array@config_calendarDateVibePattern#t

    invoke-static {v7, v8}, Lcom/android/internal/policy/impl/PhoneWindowManager;->getLongIntArray(Landroid/content/res/Resources;I)[J

    move-result-object v7

    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCalendarDateVibePattern:[J
    ...
    const v8, #android:array@config_safeModeDisabledVibePattern#t
    ...
    const v8, #android:array@config_safeModeEnabledVibePattern#t
    ...
    const v8, #android:bool@config_enableScreenshotChord#t
    ...
    .line 1586
    new-instance v7, Lcom/android/internal/policy/impl/GlobalKeyManager;

    iget-object v8, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mContext:Landroid/content/Context;

    invoke-direct {v7, v8}, Lcom/android/internal/policy/impl/GlobalKeyManager;-><init>(Landroid/content/Context;)V

    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mGlobalKeyManager:Lcom/android/internal/policy/impl/GlobalKeyManager;
    ...
    invoke-virtual {p0, v7}, Lcom/android/internal/policy/impl/PhoneWindowManager;->goingToSleep(I)V

    .line 1596
    :cond_3
    const/4 v7, 0x1

    const-string v8, "persist.applaunchtime.enable"
    ...
    new-instance v7, Lcom/android/internal/policy/impl/smartwake/WindowGestureManager;

    invoke-direct {v7, p1}, Lcom/android/internal/policy/impl/smartwake/WindowGestureManager;-><init>(Landroid/content/Context;)V

    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mWindowGestureManager:Lcom/android/internal/policy/impl/smartwake/WindowGestureManager;
    ...
    .end local v4    # "poweroffAlarmFilter":Landroid/content/IntentFilter;
    .end local v5    # "statusbarEventFilter":Landroid/content/IntentFilter;
    .end local v6    # "stkUserActivityFilter":Landroid/content/IntentFilter;
    :cond_4
    const/4 v7, 0x0
    ...
    .restart local v4    # "poweroffAlarmFilter":Landroid/content/IntentFilter;
    .restart local v5    # "statusbarEventFilter":Landroid/content/IntentFilter;
    .restart local v6    # "stkUserActivityFilter":Landroid/content/IntentFilter;
    :cond_5
    const/4 v7, 0x0
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    const-string v4, "com.mediatek.factorymode/com.mediatek.factorymode.KeyCode"
    ...
    .line 2968
    .local v44, "wifiManager":Landroid/net/wifi/WifiManager;
    invoke-virtual/range {v44 .. v44}, Landroid/net/wifi/WifiManager;->getWifiState()I

    move-result v45

    .line 2969
    .local v45, "wifiState":I
    const/4 v4, 0x3
    ...
    .line 2897
    .end local v44    # "wifiManager":Landroid/net/wifi/WifiManager;
    .end local v45    # "wifiState":I
    :cond_25
    if-nez v21, :cond_23
    ...
    .line 2971
    .restart local v44    # "wifiManager":Landroid/net/wifi/WifiManager;
    .restart local v45    # "wifiState":I
    :cond_32
    const/4 v4, 0x1
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;I)I
    ...
    const-string v33, "vibrate_buttons"
    ...
    .line 4984
    .end local v31    # "vibrateButtons":Z
    :cond_5
    const-string v32, "ro.mtk_hw_key_remapping"
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/policy/impl/keyguard/KeyguardServiceDelegate;->isShowing()Z
    ...
    :goto_a
    sget-boolean v32, Lcom/android/internal/policy/impl/PhoneWindowManager;->IS_USER_BUILD:Z
    ...
    const-string v34, "interceptKeyTq keycode="
    ...
    const-string v34, " keyguardActive="
    ...
    const-string v34, " mVolumeDownKeyTriggered ="
    ...
    const-string v34, " mVolumeUpKeyTriggered ="
    ...
    const-string v34, " useHapticFeedback = "
    ...
    .line 5083
    :cond_1c
    const-string v32, "persist.sys.smartwake_switch"
    ...
    .line 5084
    .local v21, "smartWakeGestureEnabled":Z
    :goto_b
    const-string v32, "persist.sys.smartwake_u"
    ...
    .line 5085
    .local v26, "smartWakeU":Z
    :goto_c
    const-string v32, "persist.sys.smartwake_c"
    ...
    .line 5086
    .local v18, "smartWakeC":Z
    :goto_d
    const-string v32, "persist.sys.smartwake_up"
    ...
    .line 5087
    .local v27, "smartWakeUp":Z
    :goto_e
    const-string v32, "persist.sys.smartwake_down"
    ...
    .line 5088
    .local v19, "smartWakeDown":Z
    :goto_f
    const-string v32, "persist.sys.smartwake_right"
    ...
    .line 5089
    .local v25, "smartWakeRight":Z
    :goto_10
    const-string v32, "persist.sys.smartwake_left"
    ...
    .line 5090
    .local v22, "smartWakeLeft":Z
    :goto_11
    const-string v32, "persist.sys.smartwake_e"
    ...
    .line 5091
    .local v20, "smartWakeE":Z
    :goto_12
    const-string v32, "persist.sys.smartwake_w"
    ...
    .line 5092
    .local v28, "smartWakeW":Z
    :goto_13
    const-string v32, "persist.sys.smartwake_m"
    ...
    .line 5093
    .local v23, "smartWakeM":Z
    :goto_14
    const-string v32, "persist.sys.smartwake_o"
    ...
    .line 5097
    const-string v32, "tanglei"

    const-string v33, "keyCode == KeyEvent.KEYCODE_U"
    ...
    const-string v32, "android.intent.action.GESTURE_U"
    ...
    .line 5063
    .end local v18    # "smartWakeC":Z
    .end local v19    # "smartWakeDown":Z
    .end local v20    # "smartWakeE":Z
    .end local v21    # "smartWakeGestureEnabled":Z
    .end local v22    # "smartWakeLeft":Z
    .end local v23    # "smartWakeM":Z
    .end local v24    # "smartWakeO":Z
    .end local v25    # "smartWakeRight":Z
    .end local v26    # "smartWakeU":Z
    .end local v27    # "smartWakeUp":Z
    .end local v28    # "smartWakeW":Z
    ...
    .line 5084
    .restart local v21    # "smartWakeGestureEnabled":Z
    :cond_22
    const/16 v26, 0x0
    ...
    .line 5085
    .restart local v26    # "smartWakeU":Z
    :cond_23
    const/16 v18, 0x0
    ...
    .line 5086
    .restart local v18    # "smartWakeC":Z
    :cond_24
    const/16 v27, 0x0
    ...
    .line 5087
    .restart local v27    # "smartWakeUp":Z
    :cond_25
    const/16 v19, 0x0
    ...
    .line 5088
    .restart local v19    # "smartWakeDown":Z
    :cond_26
    const/16 v25, 0x0
    ...
    .line 5089
    .restart local v25    # "smartWakeRight":Z
    :cond_27
    const/16 v22, 0x0
    ...
    .line 5090
    .restart local v22    # "smartWakeLeft":Z
    :cond_28
    const/16 v20, 0x0
    ...
    .line 5091
    .restart local v20    # "smartWakeE":Z
    :cond_29
    const/16 v28, 0x0
    ...
    .line 5092
    .restart local v28    # "smartWakeW":Z
    :cond_2a
    const/16 v23, 0x0
    ...
    .line 5093
    .restart local v23    # "smartWakeM":Z
    :cond_2b
    const/16 v24, 0x0
    ...
    .line 5102
    .restart local v24    # "smartWakeO":Z
    :cond_2c
    if-eqz v27, :cond_2d
    ...
    const-string v33, "keyCode == KeyEvent.KEYCODE_DPAD_UP"
    ...
    const-string v32, "android.intent.action.GESTURE_UP"
    ...
    const-string v33, "keyCode == KeyEvent.KEYCODE_DPAD_DOWN"
    ...
    const-string v32, "android.intent.action.GESTURE_DOWN"
    ...
    const-string v33, "keyCode == KeyEvent.KEYCODE_DPAD_RIGHT"
    ...
    const-string v32, "android.intent.action.GESTURE_RIGHT"
    ...
    const-string v33, "keyCode == KeyEvent.KEYCODE_DPAD_LEFT"
    ...
    const-string v32, "android.intent.action.GESTURE_LEFT"
    ...
    const-string v33, "keyCode == KeyEvent.KEYCODE_C"
    ...
    const-string v32, "android.intent.action.GESTURE_C"
    ...
    const-string v33, "keyCode == KeyEvent.KEYCODE_E"
    ...
    const-string v32, "android.intent.action.GESTURE_E"
    ...
    const-string v33, "keyCode == KeyEvent.KEYCODE_O"
    ...
    const-string v32, "android.intent.action.GESTURE_O"
    ...
    const-string v33, "keyCode == KeyEvent.KEYCODE_W"
    ...
    const-string v32, "android.intent.action.GESTURE_W"
    ...
    const-string v33, "keyCode == KeyEvent.KEYCODE_M"
    ...
    const-string v32, "android.intent.action.GESTURE_M"
    ...
    const-string v33, "interceptKeyBeforeQueueing: VOLUME key-down while ringing: Silence ringer!"
    ...
    const-string v32, "persist.sys.anr_sys_key"
    ...
    invoke-static/range {v32 .. v32}, Landroid/media/session/MediaSessionLegacyHelper;->getHelper(Landroid/content/Context;)Landroid/media/session/MediaSessionLegacyHelper;
    ...
    invoke-virtual/range {v34 .. v34}, Landroid/view/ViewConfiguration;->getDeviceGlobalActionKeyTimeout()J
    ...
    invoke-virtual/range {v32 .. v32}, Landroid/os/PowerManager;->isInteractive()Z
    ...
    invoke-virtual/range {v32 .. v32}, Landroid/media/session/MediaSessionLegacyHelper;->isGlobalPriorityActive()Z
    ...
    new-instance v34, Landroid/view/KeyEvent;
    ...
    const-string v33, "interceptKeyBeforeQueueing: CALL key-down while ringing: Answer the call!"
