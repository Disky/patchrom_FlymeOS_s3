...
.method public handleMessage(Landroid/os/Message;)V
    ...
    aget-object v22, v2, v23

    .line 4346
    .local v22, "streamState":Landroid/media/AudioService$VolumeStreamState;
    const/4 v2, 0x0

    # getter for: Landroid/media/AudioService$VolumeStreamState;->mIndexMax:I
    invoke-static/range {v22 .. v22}, Landroid/media/AudioService$VolumeStreamState;->access$6300(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    .line 4348
    invoke-virtual/range {v22 .. v22}, Landroid/media/AudioService$VolumeStreamState;->applyAllVolumes()V
    ...
    .end local v22    # "streamState":Landroid/media/AudioService$VolumeStreamState;
    ...
    .restart local v23    # "streamType":I
    :cond_5
    move-object/from16 v0, p0
    ...
    check-cast v18, Landroid/media/AudioService$AudioPolicyProxy;

    .line 4387
    .local v18, "policy":Landroid/media/AudioService$AudioPolicyProxy;
    invoke-virtual/range {v18 .. v18}, Landroid/media/AudioService$AudioPolicyProxy;->connectMixes()V

    goto :goto_6

    .line 4389
    .end local v13    # "i$":Ljava/util/Iterator;
    .end local v18    # "policy":Landroid/media/AudioService$AudioPolicyProxy;
    :catchall_1
    move-exception v2
    ...
    check-cast v19, Landroid/media/AudioService$LoadSoundEffectReply;

    .line 4417
    .local v19, "reply":Landroid/media/AudioService$LoadSoundEffectReply;
    monitor-enter v19
    ...
    .end local v19    # "reply":Landroid/media/AudioService$LoadSoundEffectReply;
    :sswitch_9
    move-object/from16 v0, p1
    ...
    .line 4464
    :try_start_c
    new-instance v20, Landroid/media/AudioRoutesInfo;
    ...
    .line 4465
    .local v20, "routes":Landroid/media/AudioRoutesInfo;
    monitor-exit v3
    :try_end_c
    ...
    check-cast v17, Landroid/media/IAudioRoutesObserver;

    .line 4470
    .local v17, "obs":Landroid/media/IAudioRoutesObserver;
    :try_start_d
    ...
    .line 4465
    .end local v17    # "obs":Landroid/media/IAudioRoutesObserver;
    .end local v20    # "routes":Landroid/media/AudioRoutesInfo;
    :catchall_7
    move-exception v2
