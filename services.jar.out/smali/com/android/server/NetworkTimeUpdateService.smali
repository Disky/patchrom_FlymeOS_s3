...
.method public systemRunning()V
    ...
    .line 180
    .local v16, "thread":Landroid/os/HandlerThread;
    invoke-virtual/range {v16 .. v16}, Landroid/os/HandlerThread;->start()V

    .line 181
    new-instance v7, Lcom/android/server/NetworkTimeUpdateService$MyHandler;
    ...
    invoke-direct {v7, v0, v1}, Lcom/android/server/NetworkTimeUpdateService$MyHandler;-><init>(Lcom/android/server/NetworkTimeUpdateService;Landroid/os/Looper;)V

    move-object/from16 v0, p0

    iput-object v7, v0, Lcom/android/server/NetworkTimeUpdateService;->mHandler:Landroid/os/Handler;

    .line 183
    move-object/from16 v0, p0

    iget-object v7, v0, Lcom/android/server/NetworkTimeUpdateService;->mHandler:Landroid/os/Handler;
    ...
    .line 185
    new-instance v7, Lcom/android/server/NetworkTimeUpdateService$SettingsObserver;

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/server/NetworkTimeUpdateService;->mHandler:Landroid/os/Handler;
    ...
    invoke-direct {v7, v0, v1}, Lcom/android/server/NetworkTimeUpdateService$SettingsObserver;-><init>(Landroid/os/Handler;I)V

    move-object/from16 v0, p0

    iput-object v7, v0, Lcom/android/server/NetworkTimeUpdateService;->mSettingsObserver:Lcom/android/server/NetworkTimeUpdateService$SettingsObserver;

    .line 186
    move-object/from16 v0, p0

    iget-object v7, v0, Lcom/android/server/NetworkTimeUpdateService;->mSettingsObserver:Lcom/android/server/NetworkTimeUpdateService$SettingsObserver;

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/server/NetworkTimeUpdateService;->mContext:Landroid/content/Context;

    move-object/from16 v17, v0

    move-object/from16 v0, v17

    invoke-virtual {v7, v0}, Lcom/android/server/NetworkTimeUpdateService$SettingsObserver;->observe(Landroid/content/Context;)V

    .line 189
    const-string v7, "NetworkTimeUpdateService"

    const-string v17, "add GPS time sync handler and looper"
    ...
    const-string v17, "NetworkTimeUpdateService"
    ...
    iput-object v7, v0, Lcom/android/server/NetworkTimeUpdateService;->mGpsThread:Landroid/os/HandlerThread;

    .line 191
    move-object/from16 v0, p0

    iget-object v7, v0, Lcom/android/server/NetworkTimeUpdateService;->mGpsThread:Landroid/os/HandlerThread;
    ...
    iget-object v0, v0, Lcom/android/server/NetworkTimeUpdateService;->mGpsThread:Landroid/os/HandlerThread;
    ...
    iput-object v7, v0, Lcom/android/server/NetworkTimeUpdateService;->mGpsHandler:Landroid/os/Handler;

    .line 194
    new-instance v7, Lcom/android/server/NetworkTimeUpdateService$GpsTimeSyncObserver;

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/server/NetworkTimeUpdateService;->mGpsHandler:Landroid/os/Handler;
    ...
    invoke-direct {v7, v0, v1}, Lcom/android/server/NetworkTimeUpdateService$GpsTimeSyncObserver;-><init>(Landroid/os/Handler;I)V

    move-object/from16 v0, p0

    iput-object v7, v0, Lcom/android/server/NetworkTimeUpdateService;->mGpsTimeSyncObserver:Lcom/android/server/NetworkTimeUpdateService$GpsTimeSyncObserver;

    .line 195
    move-object/from16 v0, p0

    iget-object v7, v0, Lcom/android/server/NetworkTimeUpdateService;->mGpsTimeSyncObserver:Lcom/android/server/NetworkTimeUpdateService$GpsTimeSyncObserver;
    ...
    invoke-virtual {v7, v0}, Lcom/android/server/NetworkTimeUpdateService$GpsTimeSyncObserver;->observe(Landroid/content/Context;)V

    .line 199
    const-string v7, "persist.sys.boot.count"
    ...
    .line 200
    .local v10, "icsString":Ljava/lang/String;
    if-eqz v10, :cond_1
    ...
    .line 205
    .restart local v13    # "isIcsVersion":Z
    :cond_2
    move-object/from16 v0, p0

    iget-object v7, v0, Lcom/android/server/NetworkTimeUpdateService;->mContext:Landroid/content/Context;
    ...
    sput v7, Lcom/android/server/NetworkTimeUpdateService;->mDefaultYear:I
    ...
    sput-boolean v7, Lcom/android/server/NetworkTimeUpdateService;->mIsOverMobile:Z
    ...
    .line 212
    .restart local v12    # "isFirstBoot":Z
    :cond_4
    const/4 v11, 0x0
    ...
    .line 218
    .restart local v11    # "isEmulator":Z
    :cond_5
    ...
    .line 219
    .local v9, "decryptState":Ljava/lang/String;
    const-string v7, "NetworkTimeUpdateService"
    ...
    const-string v18, "Set the date and time to: "
    ...
    const-string v18, "Set the year to "

    invoke-virtual/range {v17 .. v18}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v17

    sget v18, Lcom/android/server/NetworkTimeUpdateService;->mDefaultYear:I
    ...
    invoke-static/range {v18 .. v19}, Landroid/os/SystemClock;->setCurrentTimeMillis(J)Z
