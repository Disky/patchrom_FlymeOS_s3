...
.method private startOtherServices()V
    ...
    .local v127, "hallSwitch":Lcom/android/server/HallSwitchObserver;
    const/16 v39, 0x0
    ...
    .line 860
    #总数-4
    new-instance v126, Ljava/io/File;
    ...
    .local v126, "file":Ljava/io/File;
    invoke-virtual/range {v126 .. v126}, Ljava/io/File;->exists()Z
    ...
    #为避免添加的try_start try_end catch goto 与原代码冲突 建议自定义
    :try_start_disky_0
    const-string v4, "SystemServer"
    ...
    #总数-2
    new-instance v128, Lcom/android/server/HallSwitchObserver;

    move-object/from16 v0, v128

    invoke-direct {v0, v3}, Lcom/android/server/HallSwitchObserver;-><init>(Landroid/content/Context;)V
    :try_end_disky_0
    .catch Ljava/lang/Throwable; {:try_start_disky_0 .. :try_end_disky_0} :catch_disky_0

    .end local v127    # "hallSwitch":Lcom/android/server/HallSwitchObserver;
    .local v128, "hallSwitch":Lcom/android/server/HallSwitchObserver;
    move-object/from16 v127, v128

    .end local v126    # "file":Ljava/io/File;
    .end local v128    # "hallSwitch":Lcom/android/server/HallSwitchObserver;
    .restart local v127    # "hallSwitch":Lcom/android/server/HallSwitchObserver;
    :cond_12
    :goto_disky_0
    if-nez v61, :cond_13
    ...
    .line 866
    .end local v68    # "e":Ljava/lang/Throwable;
    .restart local v126    # "file":Ljava/io/File;
    #跳转目标同之前自定义
    :catch_disky_0
    move-exception v68
