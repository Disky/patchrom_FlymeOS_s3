...
.method private handleMobileDataSettingNotFound(Z)Z
    ...
    const-string v6, "handleMobileDataSettingNotFound: initial retVal="
    ...
    .line 934
    const-string v3, "invalid sub id, return data disabled"
    ...
    const-string v4, "persist.radio.mobile.data"

    const-string v6, "0"

    invoke-virtual {v3, v4, v6}, Lcom/android/internal/telephony/PhoneBase;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "handleMobileDataSettingNotFound: after retVal="
...
.method protected onSetUserDataEnabled(Z)V
    ...
    :goto_2
    invoke-virtual {v11, v12, v9}, Lcom/android/internal/telephony/PhoneBase;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v9}, Lcom/mediatek/internal/telephony/ltedc/svlte/SvlteIratUtils;->isIratSupportPhone(Lcom/android/internal/telephony/Phone;)Z
    ...
    .line 1631
    const-string v9, "[IRAT_DCT] IRAT support and phone ID not match."
    ...
    .line 1635
    const-string v9, "Current phone is not default phone"
    ...
    const-string v11, "onSetUserDataEnabled(): readEnabled = "
    ...
    const-string v11, ", mSettingProviderRetryCount = "
    ...
    .line 1655
    const-string v9, "write to setting un-sync! re-send msg CMD_SET_USER_DATA_ENABLE"
    ...
    .line 1681
    const-string v9, "specificDisabled"
    ...
    invoke-virtual {p0, v11}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->apnTypeToId(Ljava/lang/String;)I

    move-result v11

    const-string v12, "specificDisabled"

    invoke-virtual {p0, v9, v11, v12}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->onCleanUpConnection(ZILjava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
